...
/*!*********************!*\
  !*** ./src/regs.js ***!
  \*********************/
/*! exports provided: getRegBits, getRegName, getFloatRegName, getFmtBits, getFmtName, getFmt3Bits, getFmt3Name, isFmtString, getCondBits, getCondName, isCondString */function(module,__webpack_exports__,__webpack_require__){"use strict";eval('__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getRegBits", function() { return getRegBits; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getRegName", function() { return getRegName; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getFloatRegName", function() { return getFloatRegName; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getFmtBits", function() { return getFmtBits; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getFmtName", function() { return getFmtName; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getFmt3Bits", function() { return getFmt3Bits; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getFmt3Name", function() { return getFmt3Name; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "isFmtString", function() { return isFmtString; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getCondBits", function() { return getCondBits; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getCondName", function() { return getCondName; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "isCondString", function() { return isCondString; });\nconst regs = {\n  r0: 0,\n  zero: 0,\n  at: 1,\n  v0: 2,\n  v1: 3,\n  a0: 4,\n  a1: 5,\n  a2: 6,\n  a3: 7,\n  t0: 8,\n  t1: 9,\n  t2: 10,\n  t3: 11,\n  t4: 12,\n  t5: 13,\n  t6: 14,\n  t7: 15,\n  s0: 16,\n  s1: 17,\n  s2: 18,\n  s3: 19,\n  s4: 20,\n  s5: 21,\n  s6: 22,\n  s7: 23,\n  t8: 24,\n  t9: 25,\n  k0: 26,\n  k1: 27,\n  gp: 28,\n  sp: 29,\n  fp: 30,\n  ra: 31\n};\n\nfunction getRegBits(reg) {\n  if (!reg)\n    return undefined;\n  return regs[reg.toLowerCase()];\n}\n\nfunction getRegName(bits) {\n  for (let name in regs) {\n    if (regs[name] === bits)\n      return name;\n  }\n  return "";\n}\n\nfunction getFloatRegName(bits) {\n  if (typeof bits !== "number")\n    throw new Error("getFloatRegName encountered non-number");\n\n  return "F" + bits;\n}\n\nconst fmts = {\n  S: 16,\n  D: 17,\n  W: 20,\n  L: 21,\n};\n\nfunction getFmtBits(fmtStr) {\n  return fmts[fmtStr.toUpperCase()];\n}\n\nfunction getFmtName(bits) {\n  for (let name in fmts) {\n    if (fmts[name] === bits)\n      return name;\n  }\n  return "";\n}\n\nconst fmt3s = {\n  S: 0,\n  D: 1,\n  W: 4,\n  L: 5,\n};\n\nfunction getFmt3Bits(fmtStr) {\n  return fmt3s[fmtStr.toUpperCase()];\n}\n\nfunction getFmt3Name(bits) {\n  for (let name in fmt3s) {\n    if (fmt3s[name] === bits)\n      return name;\n  }\n  return "";\n}\n\nfunction isFmtString(fmtStr) {\n  return fmts.hasOwnProperty(fmtStr.toUpperCase()) || fmt3s.hasOwnProperty(fmtStr.toUpperCase());\n}\n\nconst conds = {\n  F: 0,\n  UN: 1,\n  EQ: 2,\n  UEQ: 3,\n  OLT: 4,\n  ULT: 5,\n  OLE: 6,\n  ULE: 7,\n  SF: 8,\n  NGLE: 9,\n  SEQ: 10,\n  NGL: 11,\n  LT: 12,\n  NGE: 13,\n  LE: 14,\n  NGT: 15,\n};\n\nfunction getCondBits(condStr) {\n  return conds[condStr.toUpperCase()];\n}\n\nfunction getCondName(bits) {\n  for (let name in conds) {\n    if (conds[name] === bits)\n      return name;\n  }\n  return "";\n}\n\nfunction isCondString(condStr) {\n  return conds.hasOwnProperty(condStr.toUpperCase());\n}\n\n\n//# sourceURL=webpack://MIPSInst/./src/regs.js?')}})},module.exports=factory()},function(n,e,t){"use strict";t.r(e),t.d(e,"assemble",(function(){return un}));var r,s=t(0);!function(n){n[n.firstPass=0]="firstPass",n[n.secondPass=1]="secondPass"}(r||(r={}));var i=new RegExp("^(@?@?[\\w\\?\\!]+)\\:");function a(n){var e=n.line.match(i);if(null===e)return!1;var t=e[1];return o(t)||f(t)||(n.currentLabel=t),c(n,t,function(n){return n.memPos+n.outIndex>>>0}(n)),t}function o(n){return 0===n.indexOf("@@")}function f(n){return 0===n.indexOf("@")&&"@"!==n[1]}function c(n,e,t){if(o(e)){if(!n.currentLabel)throw new Error("Local label "+e+" (starts with @@) cannot be used before a global label");!function(n,e,t){var r=n.localSymbols[n.currentLabel];r||(r=n.localSymbols[n.currentLabel]=Object.create(null));r[e]=t}(n,e,t)}else f(e)?function(n,e,t){n.staticSymbols[n.staticSymbols.length-1][e]=t}(n,e,t):function(n,e,t){n.symbols[e]=t,n.symbolsByValue[t]=e,n.symbolOutputMap&&(n.symbolOutputMap[e]=n.outIndex)}(n,e,t)}function l(n,e){if(o(e)){if(!n.currentLabel)throw new Error("Local label "+e+" cannot be referenced in the current scope");var t=n.localSymbols[n.currentLabel];return t&&Object.prototype.hasOwnProperty.call(t,e)?t[e]:null}if(f(e)){var s=function(n){return n.currentPass===r.firstPass?n.staticSymbols[n.staticSymbolIndices[n.staticSymbolIndices.length-1]]:n.staticSymbols[n.staticSymbolIndices[0]]}(n);return Object.prototype.hasOwnProperty.call(s,e)?s[e]:null}return Object.prototype.hasOwnProperty.call(n.symbols,e)?n.symbols[e]:null}function u(n){switch(n){case"0":case"1":case"2":case"3":case"4":case"5":case"6":case"7":return!0}return!1}function p(n){switch(n.toUpperCase()){case"0":case"1":case"2":case"3":case"4":case"5":case"6":case"7":case"8":case"9":case"A":case"B":case"C":case"D":case"E":case"F":return!0}return!1}function d(n,e){throw new Error(n+"\nLine: "+e.line)}function _(n,e){return function n(e,t){var r=m.exec(e);if(null===r){if(null!==(a=l(t,e)))return a;var s=function(n){if("string"!=typeof n)return null;var e,t="-"===n[0];return t&&(n=n.substr(1)),e="b"===n[0]||"0"===n[0]&&"b"===n[1]?parseInt(n.substr(2),2):"o"===n[0]||"0"===n[0]&&"o"===n[1]?parseInt(n.substr(2),8):"x"===n[0]||"0"===n[0]&&"x"===n[1]?parseInt(n.substr(2),16):parseInt(n,10),isNaN(e)?null:(t&&(e=-e),e)}(e);if(null!==s)return s;var i=function(n){if(n.length<2)return null;var e=n[0];if(n[n.length-1]!==e)return null;if('"'!==e&&"'"!==e)return null;for(var t="",r=1;r<n.length-1;r++){var s=n[r];if("\\"===s){var i=n[r+1],a=n[r+2],o=n[r+3];switch(i){case"\\":case'"':case"'":case"?":t+=i,r++;continue;case"n":t+="\n",r++;continue;case"r":t+="\r",r++;continue;case"t":t+="\t",r++;continue;case"b":t+="\b",r++;continue;case"x":if(!p(a))throw new Error("Hex escape sequence followed by non-hex character: "+i);p(o)?(t+=String.fromCharCode(parseInt(a+o,16)),r+=3):(t+=String.fromCharCode(parseInt(a,16)),r+=2);continue;default:if(u(i)){u(a)?u(o)?(t+=String.fromCharCode(parseInt(i+a+o,8)),r+=3):(t+=String.fromCharCode(parseInt(i+a,8)),r+=2):(t+=String.fromCharCode(parseInt(i,8)),r++);continue}}}t+=s}return t}(e);return"string"==typeof i?i:null}var a,o=r[1];if(!g[o])return null!==(a=l(t,o))?a:null;var f="",c=0,_=void 0;for(_=o.length+1;_<e.length-1;_++){var b=e[_];if("("===b)c++;else if(")"===b&&--c<0){_++;break}f+=b}var h="";_<e.length-1&&(h=e.substring(_,e.length));var y=0;if(f&&(y=n(f,t)),null===y)return d("Could not evaluate "+f,t),null;var v=g[o](t,y);return h&&(v+=h),v}(n,e)}var m=new RegExp("^([-\\w]+)\\(([\\(\\),-\\w\\?\\!\\@]*)\\)$","i");var g=Object.create(null);function b(n){2!==n.lineExpressions.length&&d(".definelabel must have two arguments, a label name and value",n);var e=n.lineExpressions[0],t=_(n.lineExpressions[1],n);return"number"!=typeof t?(d("The value in .definelabel must evaluate to a numeric value",n),!1):(c(n,e,t),!0)}g.abs=function(n,e){if("string"==typeof e)throw new Error('Assembler function abs cannot be called with string "'+e+'", value must be a number.');return Math.abs(e)},g.hi=function(n,e){if("string"==typeof e)throw new Error('Assembler function hi cannot be called with string "'+e+'", value must be a number.');var t=e>>>16;return 32768&(65535&e)&&(t+=1),t},g.lo=function(n,e){if("string"==typeof e)throw new Error('Assembler function lo cannot be called with string "'+e+'", value must be a number.');return 65535&e},g.org=function(n,e){return n.memPos+n.outIndex};var h=new RegExp("^\\.definelabel\\s+(@?@?[\\w\\?\\!]+)[\\s,]+([-\\w\\?\\!\\@]+)$","i");b.matches=function(n){return null!==n.line.match(h)};function y(n){var e=n.line,t=x(e," ","\t");if(-1!==t){var r=E(e.substr(t+1));n.lineExpressions=r}else n.lineExpressions=[]}function v(n){var e=n.line,t=x(e," ","\t");if(-1===t)return e;var r,s,i=e.substring(0,t),a=E(e.substr(t+1));if(n.lineExpressions=a,a.length>0){var o=a.map((function(e,t){var r=_(e,n);return"number"==typeof r&&t===a.length-1&&(r=function(n,e,t){if(function(n){if("b"!==(n=n.toLowerCase())[0])return!1;switch(n){case"bc1f":case"bc1fl":case"bc1t":case"bc1tl":case"beq":case"beql":case"bgez":case"bgezal":case"bgezall":case"bgezl":case"bgtz":case"bgtzl":case"blez":case"blezl":case"bltz":case"bltzal":case"bltzall":case"bltzl":case"bne":case"bnel":return!0}return!1}(n)){var r=t.memPos+t.outIndex,s=e-r;return s%4!=0&&d("Misaligned branch instruction detected",t),s/4-1}return e}(i,r,n)),r}));n.evaluatedLineExpressions=o,e=i+" "+(r=o,s=a,r.map((function(n,e){return"number"==typeof n?function(n){var e=0===n,t=n<0,r=n.toString(16).toUpperCase();return t&&(r=r.substr(1)),(t?"-":"")+(e?"":"0x")+r}(n):null===n?s[e]:n}))).join(" ")}return e}function E(n){var e=[],t="",r="",s=0,i=!1,a="";function o(n){t+=n}function f(){for(;w(t[t.length-1]);)t=t.slice(0,-1);(t=t.trim())&&(e.push(t),t="")}for(var c=0;c<n.length;c++){var l=n[c];switch(r||s||w(a)&&f(),l){case"(":i||r||s++;break;case")":if(!i&&!r){if(s<=0)throw new Error("Imbalanced parenthesis in expression: "+n);s--}break;case'"':case"'":i||(r?r===l&&(r=""):r=l)}o(l),i=!i&&"\\"===l,a=l}if(s>0)throw new Error("Imbalanced parenthesis in expression: "+n);if(r)throw new Error("Unterminated string: "+t);return f(),e}function w(n){return","===n||function(n){return" "===n||"\t"===n}(n)}function x(n){for(var e=[],t=1;t<arguments.length;t++)e[t-1]=arguments[t];for(var r=[],s=0,i=e;s<i.length;s++){var a=i[s],o=n.indexOf(a);o>=0&&r.push(o)}return 0===r.length?-1:Math.min.apply(Math,r)}function O(n,e){var t=function(n,e){return new RegExp("^\\."+n+(e?"":"\\s+"),"i")}(n,e);return function(n){return!!n.line.match(t)}}function k(n){1!==n.lineExpressions.length&&d(".org directive requires one numeric argument",n);var e=_(n.lineExpressions[0],n);return"number"!=typeof e?(d("Could not parse .org immediate "+e,n),!1):(e<0&&d(".org directive cannot be negative",n),n.memPos=e>>>0,!0)}function P(n){1!==n.lineExpressions.length&&d(".orga directive requires one numeric argument",n);var e=_(n.lineExpressions[0],n);return"number"!=typeof e?(d("Could not parse .orga immediate "+e,n),!1):(e<0&&d(".orga directive cannot be negative.",n),n.outIndex=e>>>0,!0)}function I(n){1!==n.lineExpressions.length&&d(".align requires one power of two number argument",n);var e=_(n.lineExpressions[0],n);if(null===e&&d("Could not parse .align immediate "+n.lineExpressions,n),"number"!=typeof e)return d(".align requires one power of two number argument",n),!1;for(e%2&&d(".align directive requires a power of two.",n),e<0&&d(".align directive cannot align by a negative value.",n);n.outIndex%e;)n.currentPass===r.secondPass&&n.dataView.setUint8(n.outIndex,0),n.outIndex++;return!0}function D(n){1!==n.lineExpressions.length&&d(".skip directive requires one numeric argument",n);var e=_(n.lineExpressions[0],n);return"number"!=typeof e?(d("Could not parse .skip immediate "+e,n),!1):(e<0&&d(".skip directive cannot skip a negative length.",n),n.outIndex+=e,!0)}function B(n){if(!n.lineExpressions.length||n.lineExpressions.length>2)throw new Error(".fill directive takes a length and optional value");var e,t;if("number"!=typeof(e=_(n.lineExpressions[0],n)))return d("Could not parse .fill length "+n.lineExpressions[0],n),!1;if(e<0&&d(".fill length must be positive.",n),n.lineExpressions.length>1){if("number"!=typeof(t=_(n.lineExpressions[1],n)))return d("Could not parse .fill value "+n.lineExpressions[1],n),!1}else t=0;if(n.currentPass===r.secondPass)for(var s=0;s<e;s++)n.dataView.setInt8(n.outIndex+s,t);return n.outIndex+=e,!0}function M(n){return S(n,!0)}function S(n,e){var t=[];if(n.lineExpressions.forEach((function(e){var r=_(e,n);if(null===r&&d("Could not parse .ascii value "+e,n),"number"==typeof r)t.push(r);else if("string"==typeof r)for(var s=0;s<r.length;s++)t.push(r.charCodeAt(s))})),e&&t.push(0),n.currentPass===r.secondPass)for(var s=0;s<t.length;s++)t[s]<0?n.dataView.setInt8(n.outIndex+s,t[s]):n.dataView.setUint8(n.outIndex+s,t[s]);return n.outIndex+=t.length,!0}function j(n){if(n.currentPass===r.secondPass){n.evaluatedLineExpressions.length||d(".byte directive requires arguments",n),n.evaluatedLineExpressions.some((function(n){return"number"!=typeof n}))&&d(".byte directive requires numeric arguments",n);for(var e=n.evaluatedLineExpressions,t=0;t<e.length;t++)e[t]<0?n.dataView.setInt8(n.outIndex+t,e[t]):n.dataView.setUint8(n.outIndex+t,e[t])}return n.outIndex+=n.lineExpressions.length,!0}k.matches=O("org"),P.matches=O("orga"),I.matches=O("align"),D.matches=O("skip"),B.matches=O("fill"),M.matches=O("asciiz"),S.matches=O("ascii");var L=O("byte"),R=O("db");function C(n){if(n.currentPass===r.secondPass){n.evaluatedLineExpressions.length||d(".halfword directive requires arguments",n),n.evaluatedLineExpressions.some((function(n){return"number"!=typeof n}))&&d(".halfword directive requires numeric arguments",n);for(var e=n.evaluatedLineExpressions,t=0;t<e.length;t++)e[t]<0?n.dataView.setInt16(n.outIndex+2*t,e[t]):n.dataView.setUint16(n.outIndex+2*t,e[t])}return n.outIndex+=2*n.lineExpressions.length,!0}j.matches=function(n){return L(n)||R(n)};var A=O("halfword"),U=O("dh");function T(n){if(n.currentPass===r.secondPass){n.evaluatedLineExpressions.length||d(".word directive requires arguments",n),n.evaluatedLineExpressions.some((function(n){return"number"!=typeof n}))&&d(".word directive requires numeric arguments",n);for(var e=n.evaluatedLineExpressions,t=0;t<e.length;t++)e[t]<0?n.dataView.setInt32(n.outIndex+4*t,e[t]):n.dataView.setUint32(n.outIndex+4*t,e[t])}return n.outIndex+=4*n.lineExpressions.length,!0}C.matches=function(n){return A(n)||U(n)};var q,W=O("word"),F=O("dw");function N(n){if(n.currentPass===r.secondPass){n.evaluatedLineExpressions.length||d(".float directive requires arguments",n),n.evaluatedLineExpressions.some((function(n){return"number"!=typeof n}))&&d(".float directive requires numeric arguments",n);for(var e=n.evaluatedLineExpressions,t=0;t<e.length;t++)n.dataView.setFloat32(n.outIndex+4*t,e[t])}return n.outIndex+=4*n.lineExpressions.length,!0}T.matches=function(n){return W(n)||F(n)},N.matches=O("float"),function(n){n[n.None=0]="None",n[n.AcceptingBlock=1]="AcceptingBlock",n[n.ExecutingBlock=2]="ExecutingBlock",n[n.NoLongerAcceptingBlock=4]="NoLongerAcceptingBlock",n[n.SawElse=8]="SawElse"}(q||(q={}));var K=q.AcceptingBlock|q.ExecutingBlock|q.NoLongerAcceptingBlock;function V(n,e){n.ifElseStack[n.ifElseStack.length-1]&=~K,n.ifElseStack[n.ifElseStack.length-1]|=e}function z(n){n.lineExpressions.length||d("A condition must be passed to an if directive",n),n.lineExpressions.length>1&&d("Only a single condition can be passed to an if directive",n);var e=_(n.lineExpressions[0],n);return null===e&&d("Could not parse .if condition",n),"number"!=typeof e&&d("Condition of if directive must evaluate to a numeric value, saw: "+e,n),e?n.ifElseStack.push(q.ExecutingBlock):n.ifElseStack.push(q.AcceptingBlock),!0}function $(n){n.lineExpressions.length&&d("The else directive cannot take a condition or parameters",n),n.ifElseStack.length||d("An else directive was reached, but there was no previous if directive",n);var e=n.ifElseStack[n.ifElseStack.length-1];switch(e&q.SawElse&&d("Encountered another else directive, but an else directive was already passed",n),e&K){case q.AcceptingBlock:V(n,q.ExecutingBlock);break;case q.ExecutingBlock:V(n,q.NoLongerAcceptingBlock);break;case q.NoLongerAcceptingBlock:break;default:d("Unexpected conditional block state: "+e.toString(16),n)}return n.ifElseStack[n.ifElseStack.length-1]|=q.SawElse,!0}function G(n){n.lineExpressions.length||d("A condition must be passed to an elseif directive",n),n.lineExpressions.length>1&&d("Only a single condition can be passed to an elseif directive",n),n.ifElseStack.length||d("An elseif directive was reached, but there was no previous if directive",n);var e=n.ifElseStack[n.ifElseStack.length-1];e&q.SawElse&&d("Encountered an elseif after seeing an else directive",n);var t=_(n.lineExpressions[0],n);switch(null===t&&d("Could not parse .elseif condition",n),"number"!=typeof t&&d("Condition of elseif directive must evaluate to a numeric value, saw: "+t,n),e&K){case q.AcceptingBlock:t&&V(n,q.ExecutingBlock);break;case q.ExecutingBlock:V(n,q.NoLongerAcceptingBlock);break;case q.NoLongerAcceptingBlock:break;default:d("Unexpected conditional block state: "+e.toString(16),n)}return!0}function Q(n){return n.lineExpressions.length&&d("The endif directive cannot take a condition or parameters",n),n.ifElseStack.length||d("An endif directive was reached, but there was no previous if directive",n),n.ifElseStack.pop(),!0}function H(n){n.lineExpressions.length||d("A file name must be passed to an include directive",n),n.lineExpressions.length>1&&d("Only a single file name can be passed to an include directive",n);var e=_(n.lineExpressions[0],n);if(null===e&&d("Could not parse .include file name",n),"string"==typeof e){var t=n.files[e];"string"!=typeof t&&d("The "+e+" file was not a string",n),n.currentPass===r.firstPass?(n.linesToInsert=".beginfile\n"+t+"\n.endfile",n.line=""):d("The `include` directive shouldn't be present after the first assembly phase",n)}else d("File name of include directive must evaluate to a string, saw: "+e,n)}function Z(n){return n.lineExpressions.length&&d("The beginfile directive takes no arguments",n),function(n){if(n.currentPass===r.firstPass){n.staticSymbols.push(Object.create(null));var e=n.staticSymbolIndices[n.staticSymbolIndices.length-1],t=n.staticSymbols.length-1;n.staticSymbolIndices.before[t]=e,n.staticSymbolIndices.push(t)}else n.staticSymbolIndices.shift()}(n),!0}function J(n){return n.lineExpressions.length&&d("The endfile directive takes no arguments",n),function(n){if(n.currentPass===r.firstPass){var e=n.staticSymbolIndices;e.push(e.before[e[e.length-1]])}else n.staticSymbolIndices.shift()}(n),!0}function X(n){var e=function(n){return new RegExp("^"+n+"\\s+","i")}(n);return function(n){return!!n.line.match(e)}}function Y(n){n.currentPass===r.firstPass?(2!==n.lineExpressions.length&&d("The `beqz` macro must take a register and label",n),n.line="",n.linesToInsert="BEQ "+n.lineExpressions[0]+" R0 "+n.lineExpressions[1]):d("The `beqz` macro shouldn't be present after the first assembly phase",n)}function nn(n){n.currentPass===r.firstPass?(2!==n.lineExpressions.length&&d("The `bnez` macro must take a register and label",n),n.line="",n.linesToInsert="BNE "+n.lineExpressions[0]+" R0 "+n.lineExpressions[1]):d("The `bnez` macro shouldn't be present after the first assembly phase",n)}function en(n){n.currentPass===r.firstPass?(2!==n.lineExpressions.length&&d("The `bnezl` macro must take a register and label",n),n.line="",n.linesToInsert="BNEL "+n.lineExpressions[0]+" R0 "+n.lineExpressions[1]):d("The `bnezl` macro shouldn't be present after the first assembly phase",n)}function tn(n){if(n.currentPass===r.firstPass){n.lineExpressions.length<=1&&d("The `li` macro must take a register and immediate",n);var e=n.lineExpressions[0],t=_(n.lineExpressions[1],n);if(null===t)return n.line="",void(n.linesToInsert="LUI "+e+", hi("+n.lineExpressions[1]+")\nADDIU "+e+", "+e+", lo("+n.lineExpressions[1]+")");if("number"==typeof t)if(n.line="",t>=-32768&&t<=32767)n.linesToInsert="ADDIU "+e+", R0, "+t;else if(t>0&&t<=65535)n.linesToInsert="ORI "+e+", R0, "+t;else if(0==(65535&t))n.linesToInsert="LUI "+e+", "+(t>>16);else if(t>=-4294967295&&t<=4294901759){var s=0!=(32768&t);n.linesToInsert="LUI "+e+", "+((t>>>16)+(s?1:0))+"\nADDIU "+e+", "+e+", "+(65535&t)}else d("li immediate value "+t+" seems out of range",n);else d("Immediate value of `li` macro must evaluate to a number, saw: "+t,n)}else d("The `li` macro shouldn't be present after the first assembly phase",n)}function rn(n){n.currentPass===r.firstPass?(2!==n.lineExpressions.length&&d("The `move` macro must take two registers",n),n.line="",n.linesToInsert="ADDU "+n.lineExpressions[0]+" "+n.lineExpressions[1]+" R0"):d("The `move` macro shouldn't be present after the first assembly phase",n)}z.matches=O("if"),$.matches=O("else",!0),G.matches=O("elseif"),Q.matches=O("endif",!0),H.matches=O("include"),Z.matches=O("beginfile",!0),J.matches=O("endfile",!0),Y.matches=X("beqz"),nn.matches=X("bnez"),en.matches=X("bnezl"),tn.matches=X("li"),rn.matches=X("move");var sn=[b,k,P,I,D,B,S,M,j,C,T,N,z,G,$,Q,H,Z,J],an=[Y,nn,en,tn,rn];function on(n){for(var e=0,t=sn;e<t.length;e++){var r=t[e];if(r.matches(n))return r}for(var s=0,i=an;s<i.length;s++){var a=i[s];if(a.matches(n))return a}return null}function fn(n,e){e(n)}function cn(n,e){return n.substr(0,e.length)===e}var ln=function(){for(var n=0,e=0,t=arguments.length;e<t;e++)n+=arguments[e].length;var r=Array(n),s=0;for(e=0;e<t;e++)for(var i=arguments[e],a=0,o=i.length;a<o;a++,s++)r[s]=i[a];return r};function un(n,e){e=e||{};for(var t=_n(n),i=function(n){var e=[0];return e.before=Object.create(null),{buffer:null,dataView:null,line:"",memPos:0,outIndex:0,symbols:Object.create(null),symbolsByValue:Object.create(null),symbolOutputMap:n.symbolOutputMap,currentLabel:null,localSymbols:Object.create(null),staticSymbols:[Object.create(null)],staticSymbolIndices:e,currentPass:r.firstPass,lineExpressions:[],evaluatedLineExpressions:null,ifElseStack:[],files:n.files||Object.create(null),linesToInsert:null}}(e),a=[],o=[],f=0;f<t.length;f++){var c=t[f];if(i.line=c,pn(i))c&&o.push(c);else{c=dn(i);var l=on(i);if(l?(y(i),fn(i,l),c=i.line):c&&(i.outIndex+=4),c&&o.push(c),"linesToInsert"in i&&i.linesToInsert){var u=_n(i.linesToInsert);t.splice.apply(t,ln([f+1,0],u)),i.linesToInsert=null}}}return t=o,i.buffer=e.buffer||new ArrayBuffer(i.outIndex),i.dataView=new DataView(i.buffer),i.memPos=0,i.outIndex=0,i.currentPass=r.secondPass,t.forEach((function(n){if(i.line=n,i.lineExpressions=[],i.evaluatedLineExpressions=[],pn(i))return n;var t=on(i);if(t)return v(i),void fn(i,t);var r,o=function(n,e){return n.symbolsByValue[e]||null}(i,i.memPos+i.outIndex);null!==o&&(i.currentLabel=o),n=i.line=v(i),e.text&&a.push(n);try{r=Object(s.parse)(n)}catch(n){return void d(n,i)}i.dataView.setUint32(i.outIndex,r),i.outIndex+=4})),i.ifElseStack.length&&d("An if directive was used without an endif directive",i),0!==i.staticSymbolIndices[0]&&d("A beginfile directive was used without an endfile directive",i),e.text?a:i.buffer}function pn(n){var e,t;return!!n.ifElseStack.length&&!(n.ifElseStack[n.ifElseStack.length-1]&q.ExecutingBlock||(e=n.line,t=e.toLowerCase(),cn(t,".if")||cn(t,".else")||cn(t,".endif")))}function dn(n){for(var e;e=a(n);)n.line=n.line.substr(e.length+1).trim();return n.line}function _n(n){var e=function(n){if("string"==typeof n)return n.split(/\r?\n/);if(!Array.isArray(n))throw new Error("Input must be a string or array of strings");return n}(n);return e=(e=(e=function(n){var e=!1,t=n.map((function(n){e&&((r=n.indexOf("*/"))>=0&&(n=n.substr(r+2),e=!1));if(e)return"";for(var t=n.indexOf("/*");t>=0;){if(mn(n,t))t++;else{var r;if(!((r=n.indexOf("*/",t+2))>=0)){n=n.substr(0,t),e=!0;break}n=n.substr(0,t)+n.substr(r+2)}t=n.indexOf("/*",t)}for(var s=n.indexOf(";");s>=0;){if(!mn(n,s)){n=n.substr(0,s),e=!1;break}s=n.indexOf(";",s+1)}for(var i=n.indexOf("//");i>=0;){if(!mn(n,i)){n=n.substr(0,i),e=!1;break}i=n.indexOf("//",i+2)}return n}));if(e)throw new Error("Unclosed block comment detected.");return t}(e=e.filter((function(n){return"string"==typeof n})))).map((function(n){return n.trim()}))).filter(Boolean)}function mn(n,e){return gn(n,e,'"')||gn(n,e,"'")}function gn(n,e,t){var r=n.indexOf(t);return-1!==r&&(!(r>e)&&-1!==n.indexOf(t,e))}}])}));