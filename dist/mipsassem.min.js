...
/*!*********************!*\
  !*** ./src/regs.js ***!
  \*********************/
/*! exports provided: getRegBits, getRegName, getFloatRegName, getFmtBits, getFmtName, getFmt3Bits, getFmt3Name, isFmtString, getCondBits, getCondName, isCondString */function(module,__webpack_exports__,__webpack_require__){"use strict";eval('__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getRegBits", function() { return getRegBits; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getRegName", function() { return getRegName; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getFloatRegName", function() { return getFloatRegName; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getFmtBits", function() { return getFmtBits; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getFmtName", function() { return getFmtName; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getFmt3Bits", function() { return getFmt3Bits; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getFmt3Name", function() { return getFmt3Name; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "isFmtString", function() { return isFmtString; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getCondBits", function() { return getCondBits; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getCondName", function() { return getCondName; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "isCondString", function() { return isCondString; });\nconst regs = {\n  r0: 0,\n  zero: 0,\n  at: 1,\n  v0: 2,\n  v1: 3,\n  a0: 4,\n  a1: 5,\n  a2: 6,\n  a3: 7,\n  t0: 8,\n  t1: 9,\n  t2: 10,\n  t3: 11,\n  t4: 12,\n  t5: 13,\n  t6: 14,\n  t7: 15,\n  s0: 16,\n  s1: 17,\n  s2: 18,\n  s3: 19,\n  s4: 20,\n  s5: 21,\n  s6: 22,\n  s7: 23,\n  t8: 24,\n  t9: 25,\n  k0: 26,\n  k1: 27,\n  gp: 28,\n  sp: 29,\n  fp: 30,\n  ra: 31\n};\n\nfunction getRegBits(reg) {\n  if (!reg)\n    return undefined;\n  return regs[reg.toLowerCase()];\n}\n\nfunction getRegName(bits) {\n  for (let name in regs) {\n    if (regs[name] === bits)\n      return name;\n  }\n  return "";\n}\n\nfunction getFloatRegName(bits) {\n  if (typeof bits !== "number")\n    throw new Error("getFloatRegName encountered non-number");\n\n  return "F" + bits;\n}\n\nconst fmts = {\n  S: 16,\n  D: 17,\n  W: 20,\n  L: 21,\n};\n\nfunction getFmtBits(fmtStr) {\n  return fmts[fmtStr.toUpperCase()];\n}\n\nfunction getFmtName(bits) {\n  for (let name in fmts) {\n    if (fmts[name] === bits)\n      return name;\n  }\n  return "";\n}\n\nconst fmt3s = {\n  S: 0,\n  D: 1,\n  W: 4,\n  L: 5,\n};\n\nfunction getFmt3Bits(fmtStr) {\n  return fmt3s[fmtStr.toUpperCase()];\n}\n\nfunction getFmt3Name(bits) {\n  for (let name in fmt3s) {\n    if (fmt3s[name] === bits)\n      return name;\n  }\n  return "";\n}\n\nfunction isFmtString(fmtStr) {\n  return fmts.hasOwnProperty(fmtStr.toUpperCase()) || fmt3s.hasOwnProperty(fmtStr.toUpperCase());\n}\n\nconst conds = {\n  F: 0,\n  UN: 1,\n  EQ: 2,\n  UEQ: 3,\n  OLT: 4,\n  ULT: 5,\n  OLE: 6,\n  ULE: 7,\n  SF: 8,\n  NGLE: 9,\n  SEQ: 10,\n  NGL: 11,\n  LT: 12,\n  NGE: 13,\n  LE: 14,\n  NGT: 15,\n};\n\nfunction getCondBits(condStr) {\n  return conds[condStr.toUpperCase()];\n}\n\nfunction getCondName(bits) {\n  for (let name in conds) {\n    if (conds[name] === bits)\n      return name;\n  }\n  return "";\n}\n\nfunction isCondString(condStr) {\n  return conds.hasOwnProperty(condStr.toUpperCase());\n}\n\n\n//# sourceURL=webpack://MIPSInst/./src/regs.js?')}})})},function(n,t,e){"use strict";e.r(t);var r,s=e(0);!function(n){n[n.firstPass=0]="firstPass",n[n.secondPass=1]="secondPass"}(r||(r={}));var i=new RegExp("^((?:@@)?[\\w\\?\\!]+)\\:");function a(n){var t=n.line.match(i);if(null===t)return!1;var e=t[1];if(o(e)){if(!n.currentLabel)throw new Error("Local label "+e+" (starts with @@) cannot be used before a global label");!function(n,t,e){var r=n.localSymbols[n.currentLabel];r||(r=n.localSymbols[n.currentLabel]=Object.create(null));r[t]=e}(n,e,f(n))}else n.currentLabel=e,u(n,e,f(n));return e}function o(n){return 0===n.indexOf("@@")}function f(n){return n.memPos+n.outIndex>>>0}function u(n,t,e){n.symbols[t]=e,n.symbolsByValue[e]=t,n.symbolOutputMap&&(n.symbolOutputMap[t]=n.outIndex)}function l(n,t){if(o(t)){if(!n.currentLabel)throw new Error("Local label "+t+" cannot be referenced in the current scope");var e=n.localSymbols[n.currentLabel];return e&&Object.prototype.hasOwnProperty.call(e,t)?e[t]:null}return Object.prototype.hasOwnProperty.call(n.symbols,t)?n.symbols[t]:null}function c(n,t){return function n(t,e){var r=_.exec(t);if(null===r){var s=function(n){if("string"!=typeof n)return null;var t,e="-"===n[0];return e&&(n=n.substr(1)),t="b"===n[0]||"0"===n[0]&&"b"===n[1]?parseInt(n.substr(2),2):"o"===n[0]||"0"===n[0]&&"o"===n[1]?parseInt(n.substr(2),8):"x"===n[0]||"0"===n[0]&&"x"===n[1]?parseInt(n.substr(2),16):parseInt(n,10),isNaN(t)?null:(e&&(t=-t),t)}(t);if(null!==s)return s;var i=function(n){if(n.length<2)return null;var t=n[0];if(n[n.length-1]!==t)return null;if('"'!==t&&"'"!==t)return null;for(var e="",r=1;r<n.length-1;r++){var s=n[r];if("\\"===s){var i=n[r+1];switch(i){case"\\":case'"':case"'":e+=i,r++;continue}}e+=s}return e}(t);if("string"==typeof i)return i;var a=l(e,t);return null!==a?a:null}var o=r[1];if(!p[o]){var a=l(e,o);return null!==a?a:null}var f="",u=0,c=void 0;for(c=o.length+1;c<t.length-1;c++){var d=t[c];if("("===d)u++;else if(")"===d&&--u<0){c++;break}f+=d}var m=void 0;return c<t.length-1?(m=t.substring(c,t.length),p[o](e,n(f,e))+m):p[o](e,n(f,e))}(n,t)}var _=new RegExp("^(\\w+)\\(([\\(\\),\\w\\?\\!]*)\\)$","i");var p=Object.create(null);p.hi=function(n,t){if("string"==typeof t)throw new Error('Assembler function hi cannot be called with string "'+t+'", value must be a number.');var e=t>>>16;return 32768&(65535&t)&&(e+=1),e},p.lo=function(n,t){if("string"==typeof t)throw new Error('Assembler function lo cannot be called with string "'+t+'", value must be a number.');return 65535&t},p.org=function(n,t){return n.memPos+n.outIndex};var d=new RegExp("^\\.definelabel\\s+((?:@@)?[\\w\\?\\!]+)[\\s,]+([-\\w\\?\\!]+)$","i");function m(n){if(null===n.line.match(d))return!1;if(2!==n.lineExpressions.length)throw new Error(".definelabel must have two arguments, a label name and value");var t=n.lineExpressions[0],e=c(n.lineExpressions[1],n);if("number"!=typeof e)throw new Error("The value in .definelabel must evaluate to a numeric value");return u(n,t,e),!0}var b=/^\.org\s+/i;function g(n){if(null===n.line.match(b))return!1;if(1!==n.lineExpressions.length)throw new Error(".org directive requires one numeric argument");var t=c(n.lineExpressions[0],n);if("number"!=typeof t)throw new Error("Could not parse .org immediate "+t);if(t<0)throw new Error(".org directive cannot be negative");return n.memPos=t>>>0,!0}var y=/^\.orga\s+/i;function h(n){if(null===n.line.match(y))return!1;if(1!==n.lineExpressions.length)throw new Error(".orga directive requires one numeric argument");var t=c(n.lineExpressions[0],n);if("number"!=typeof t)throw new Error("Could not parse .orga immediate "+t);if(t<0)throw new Error(".orga directive cannot be negative.");return n.outIndex=t>>>0,!0}var w=/^\.align\s+/i;function v(n){if(null===n.line.match(w))return!1;if(1!==n.lineExpressions.length)throw new Error(".align requires one power of two number argument");var t=c(n.lineExpressions[0],n);if(null===t)throw new Error("Could not parse .align immediate "+n.lineExpressions);if("number"!=typeof t)throw new Error(".align requires one power of two number argument");if(t%2)throw new Error(".align directive requires a power of two.");if(t<0)throw new Error(".align directive cannot align by a negative value.");for(;n.outIndex%t;)n.currentPass===r.secondPass&&n.dataView.setUint8(n.outIndex,0),n.outIndex++;return!0}var E=/^\.skip\s+/i;function O(n){if(null===n.line.match(E))return!1;if(1!==n.lineExpressions.length)throw new Error(".skip directive requires one numeric argument");var t=c(n.lineExpressions[0],n);if("number"!=typeof t)throw new Error("Could not parse .skip immediate "+t);if(t<0)throw new Error(".skip directive cannot skip a negative length.");return n.outIndex+=t,!0}var x=/^\.fill\s+/i;function P(n){var t,e;if(null===n.line.match(x))return!1;if(!n.lineExpressions.length||n.lineExpressions.length>2)throw new Error(".fill directive takes a length and optional value");if("number"!=typeof(t=c(n.lineExpressions[0],n)))throw new Error("Could not parse .fill length "+n.lineExpressions[0]);if(t<0)throw new Error(".fill length must be positive.");if(n.lineExpressions.length>1){if("number"!=typeof(e=c(n.lineExpressions[1],n)))throw new Error("Could not parse .fill value "+n.lineExpressions[1])}else e=0;if(n.currentPass===r.secondPass)for(var s=0;s<t;s++)n.dataView.setInt8(n.outIndex+s,e);return n.outIndex+=t,!0}var D=/^\.ascii\s+/i,k=/^\.asciiz\s+/i;function M(n){var t=!1,e=n.line.match(D);if(!e){if(!(e=n.line.match(k)))return!1;t=!0}var s=[];if(n.lineExpressions.forEach(function(t){var e=c(t,n);if(null===e)throw new Error("Could not parse .ascii value "+t);if("number"==typeof e)s.push(e);else if("string"==typeof e)for(var r=0;r<e.length;r++)s.push(e.charCodeAt(r))}),t&&s.push(0),n.currentPass===r.secondPass)for(var i=0;i<s.length;i++)s[i]<0?n.dataView.setInt8(n.outIndex+i,s[i]):n.dataView.setUint8(n.outIndex+i,s[i]);return n.outIndex+=s.length,!0}var I=",-\\w\\s\\(\\)\\?\\!";function j(n){var t=n.line,e=t.indexOf(" ");if(-1===e)return t;var r=t.substring(0,e),s=B(t.substr(e+1));if(n.lineExpressions=s,s.length>0){var i=s.map(function(t,e){var i=c(t,n);return"number"==typeof i&&e===s.length-1&&(i=function(n,t,e){if(function(n){if("b"!==(n=n.toLowerCase())[0])return!1;switch(n){case"bc1f":case"bc1fl":case"bc1t":case"bc1tl":case"beq":case"beql":case"bgez":case"bgezal":case"bgezall":case"bgezl":case"bgtz":case"bgtzl":case"blez":case"blezl":case"bltz":case"bltzal":case"bltzall":case"bltzl":case"bne":case"bnel":return!0}return!1}(n)){var r=e.memPos+e.outIndex,s=(t-r)/4-1;return s}return t}(r,i,n)),i});n.evaluatedLineExpressions=i,t=r+" "+function(n,t){return n.map(function(n,e){return"number"==typeof n?function(n){var t=0===n,e=n<0,r=n.toString(16).toUpperCase();return e&&(r=r.substr(1)),(e?"-":"")+(t?"":"0x")+r}(n):null===n?t[e]:n})}(i,s).join(" ")}return t}function B(n){var t=[],e="",r="",s=0,i=!1,a="";function o(n){e+=n}function f(){for(;L(e[e.length-1]);)e=e.slice(0,-1);(e=e.trim())&&(t.push(e),e="")}for(var u=0;u<n.length;u++){var l=n[u];switch(r||s||L(a)&&f(),l){case"\\":i||(i=!0);break;case"(":i||r||s++;break;case")":if(!i&&!r){if(s<=0)throw new Error("Imbalanced parenthesis in expression: "+n);s--}break;case'"':case"'":i||(r?r===l&&(r=""):r=l)}o(l),"\\"!==l&&(i=!1),a=l}if(s>0)throw new Error("Imbalanced parenthesis in expression: "+n);if(r)throw new Error("Unterminated string: "+e);return f(),t}function L(n){return","===n||function(n){return" "===n||"\t"===n}(n)}function R(n){return new RegExp("^\\."+n+"\\s+(["+I+"]+)$","i")}var S=R("byte"),C=R("db");function U(n){var t=n.line.match(S);if(!t&&!(t=n.line.match(C)))return!1;if(n.currentPass===r.secondPass){if(!n.evaluatedLineExpressions.length)throw new Error(".byte directive requires arguments");if(n.evaluatedLineExpressions.some(function(n){return"number"!=typeof n}))throw new Error(".byte directive requires numeric arguments");for(var e=n.evaluatedLineExpressions,s=0;s<e.length;s++)e[s]<0?n.dataView.setInt8(n.outIndex+s,e[s]):n.dataView.setUint8(n.outIndex+s,e[s])}return n.outIndex+=n.lineExpressions.length,!0}var A=R("halfword"),q=R("dh");function T(n){var t=n.line.match(A);if(!t&&!(t=n.line.match(q)))return!1;if(n.currentPass===r.secondPass){if(!n.evaluatedLineExpressions.length)throw new Error(".halfword directive requires arguments");if(n.evaluatedLineExpressions.some(function(n){return"number"!=typeof n}))throw new Error(".halfword directive requires numeric arguments");for(var e=n.evaluatedLineExpressions,s=0;s<e.length;s++)e[s]<0?n.dataView.setInt16(n.outIndex+2*s,e[s]):n.dataView.setUint16(n.outIndex+2*s,e[s])}return n.outIndex+=2*n.lineExpressions.length,!0}var W=R("word"),F=R("dw");function K(n){var t=n.line.match(W);if(!t&&!(t=n.line.match(F)))return!1;if(n.currentPass===r.secondPass){if(!n.evaluatedLineExpressions.length)throw new Error(".word directive requires arguments");if(n.evaluatedLineExpressions.some(function(n){return"number"!=typeof n}))throw new Error(".word directive requires numeric arguments");for(var e=n.evaluatedLineExpressions,s=0;s<e.length;s++)e[s]<0?n.dataView.setInt32(n.outIndex+4*s,e[s]):n.dataView.setUint32(n.outIndex+4*s,e[s])}return n.outIndex+=4*n.lineExpressions.length,!0}var V=/^\.float\s+([,-\.\w\s\(\)]+)$/i;function N(n){var t=n.line.match(V);if(!t)return!1;var e=t[1].split(",").map(function(n){return n.trim()}).filter(function(n){return!!n});if(n.currentPass===r.secondPass)for(var s=e.map(function(n){var t=parseFloat(n);if(null===t)throw new Error("Could not parse .float immediate "+n);return t}),i=0;i<s.length;i++)n.dataView.setFloat32(n.outIndex+4*i,s[i]);return n.outIndex+=4*e.length,!0}function z(n){if(![m,g,h,v,O,P,M,U,T,K,N].some(function(t){return t(n)}))throw new Error("handleDirective: Unrecongized directive "+n.line)}function $(n,t){t=t||{};var e=function(n){if("string"==typeof n)return n.split(/\r?\n/);if(!Array.isArray(n))throw new Error("Input must be a string or array of strings");return n}(n);e=(e=(e=function(n){return n.map(function(n){var t=n.indexOf(";"),e=n.indexOf("//");if(-1===t&&-1===e)return n;var r=t;return-1===r?r=e:-1!==e&&(r=Math.min(t,e)),n.substr(0,r)})}(e=e.filter(function(n){return"string"==typeof n}))).map(function(n){return n.trim()})).filter(Boolean);var i=function(n){return{buffer:null,dataView:null,line:"",memPos:0,outIndex:0,symbols:Object.create(null),symbolsByValue:Object.create(null),symbolOutputMap:n.symbolOutputMap,currentLabel:null,localSymbols:Object.create(null),currentPass:r.firstPass,lineExpressions:[],evaluatedLineExpressions:null}}(t),o=[];return e=(e=e.map(function(n){var t;for(i.line=n;t=a(i);)i.line=n=n.substr(t.length+1).trim();return"."===n[0]?(function(n){var t=n.line,e=t.indexOf(" ");if(-1!==e){var r=B(t.substr(e+1));n.lineExpressions=r}else n.lineExpressions=[]}(i),z(i),n):(n&&(i.outIndex+=4),n)})).filter(Boolean),i.buffer=t.buffer||new ArrayBuffer(i.outIndex),i.dataView=new DataView(i.buffer),i.memPos=0,i.outIndex=0,i.currentPass=r.secondPass,e.forEach(function(n){if(i.line=n,i.lineExpressions=[],i.evaluatedLineExpressions=[],"."===n[0])return j(i),void z(i);var e=function(n,t){return n.symbolsByValue[t]||null}(i,i.memPos+i.outIndex);null!==e&&(i.currentLabel=e),n=i.line=j(i),t.text&&o.push(n);var r=Object(s.parse)(n);i.dataView.setUint32(i.outIndex,r),i.outIndex+=4}),t.text?o:i.buffer}e.d(t,"assemble",function(){return $})}])});