...
/*!*********************!*\
  !*** ./src/regs.js ***!
  \*********************/
/*! exports provided: getRegBits, getRegName, getFloatRegName, getFmtBits, getFmtName, getFmt3Bits, getFmt3Name, isFmtString, getCondBits, getCondName, isCondString */function(module,__webpack_exports__,__webpack_require__){"use strict";eval('__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getRegBits", function() { return getRegBits; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getRegName", function() { return getRegName; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getFloatRegName", function() { return getFloatRegName; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getFmtBits", function() { return getFmtBits; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getFmtName", function() { return getFmtName; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getFmt3Bits", function() { return getFmt3Bits; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getFmt3Name", function() { return getFmt3Name; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "isFmtString", function() { return isFmtString; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getCondBits", function() { return getCondBits; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getCondName", function() { return getCondName; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "isCondString", function() { return isCondString; });\nconst regs = {\n  r0: 0,\n  zero: 0,\n  at: 1,\n  v0: 2,\n  v1: 3,\n  a0: 4,\n  a1: 5,\n  a2: 6,\n  a3: 7,\n  t0: 8,\n  t1: 9,\n  t2: 10,\n  t3: 11,\n  t4: 12,\n  t5: 13,\n  t6: 14,\n  t7: 15,\n  s0: 16,\n  s1: 17,\n  s2: 18,\n  s3: 19,\n  s4: 20,\n  s5: 21,\n  s6: 22,\n  s7: 23,\n  t8: 24,\n  t9: 25,\n  k0: 26,\n  k1: 27,\n  gp: 28,\n  sp: 29,\n  fp: 30,\n  ra: 31\n};\n\nfunction getRegBits(reg) {\n  if (!reg)\n    return undefined;\n  return regs[reg.toLowerCase()];\n}\n\nfunction getRegName(bits) {\n  for (let name in regs) {\n    if (regs[name] === bits)\n      return name;\n  }\n  return "";\n}\n\nfunction getFloatRegName(bits) {\n  if (typeof bits !== "number")\n    throw new Error("getFloatRegName encountered non-number");\n\n  return "F" + bits;\n}\n\nconst fmts = {\n  S: 16,\n  D: 17,\n  W: 20,\n  L: 21,\n};\n\nfunction getFmtBits(fmtStr) {\n  return fmts[fmtStr.toUpperCase()];\n}\n\nfunction getFmtName(bits) {\n  for (let name in fmts) {\n    if (fmts[name] === bits)\n      return name;\n  }\n  return "";\n}\n\nconst fmt3s = {\n  S: 0,\n  D: 1,\n  W: 4,\n  L: 5,\n};\n\nfunction getFmt3Bits(fmtStr) {\n  return fmt3s[fmtStr.toUpperCase()];\n}\n\nfunction getFmt3Name(bits) {\n  for (let name in fmt3s) {\n    if (fmt3s[name] === bits)\n      return name;\n  }\n  return "";\n}\n\nfunction isFmtString(fmtStr) {\n  return fmts.hasOwnProperty(fmtStr.toUpperCase()) || fmt3s.hasOwnProperty(fmtStr.toUpperCase());\n}\n\nconst conds = {\n  F: 0,\n  UN: 1,\n  EQ: 2,\n  UEQ: 3,\n  OLT: 4,\n  ULT: 5,\n  OLE: 6,\n  ULE: 7,\n  SF: 8,\n  NGLE: 9,\n  SEQ: 10,\n  NGL: 11,\n  LT: 12,\n  NGE: 13,\n  LE: 14,\n  NGT: 15,\n};\n\nfunction getCondBits(condStr) {\n  return conds[condStr.toUpperCase()];\n}\n\nfunction getCondName(bits) {\n  for (let name in conds) {\n    if (conds[name] === bits)\n      return name;\n  }\n  return "";\n}\n\nfunction isCondString(condStr) {\n  return conds.hasOwnProperty(condStr.toUpperCase());\n}\n\n\n//# sourceURL=webpack://MIPSInst/./src/regs.js?')}})})},function(n,t,e){"use strict";e.r(t);var r,s=e(0);function i(n){if("string"!=typeof n)return null;var t,e="-"===n[0];return e&&(n=n.substr(1)),t="b"===n[0]||"0"===n[0]&&"b"===n[1]?parseInt(n.substr(2),2):"o"===n[0]||"0"===n[0]&&"o"===n[1]?parseInt(n.substr(2),8):"x"===n[0]||"0"===n[0]&&"x"===n[1]?parseInt(n.substr(2),16):parseInt(n,10),isNaN(t)?null:(e&&(t=-t),t)}function a(n){var t=n.line.match(/^((?:@@)?[\w\?\!]+)\:/);if(null===t)return!1;var e=t[1];if(o(e)){if(!n.currentLabel)throw new Error("Local label "+e+" (starts with @@) cannot be used before a global label");!function(n,t,e){var r=n.localSymbols[n.currentLabel];r||(r=n.localSymbols[n.currentLabel]=Object.create(null));r[t]=e}(n,e,f(n))}else n.currentLabel=e,l(n,e,f(n));return e}function o(n){return 0===n.indexOf("@@")}function f(n){return n.memPos+n.outIndex>>>0}function l(n,t,e){n.symbols[t]=e,n.symbolsByValue[e]=t}function u(n,t){if(o(t)){if(!n.currentLabel)throw new Error("Local label "+t+" cannot be referenced in the current scope");var e=n.localSymbols[n.currentLabel];return e&&Object.prototype.hasOwnProperty.call(e,t)?e[t]:null}return Object.prototype.hasOwnProperty.call(n.symbols,t)?n.symbols[t]:null}!function(n){n[n.firstPass=0]="firstPass",n[n.secondPass=1]="secondPass"}(r||(r={}));var _=/^\.definelabel\s+(\w+)[\s,]+([-\w]+)$/i;function c(n){var t=n.line.match(_);if(null===t)return!1;var e=t[1],r=t[2],s=i(r);if(null===s){var a=u(n,r);if(null===a)throw new Error(".definelabel value must be numeric or an alias to another label");l(n,e,a)}else l(n,e,s);return!0}var p=/^\.org\s+(\w+)$/i;function d(n){var t=n.line.match(p);if(null===t)return!1;var e=t[1],r=i(e);if(null===r)throw new Error("Could not parse .org immediate "+e);return n.memPos=r>>>0,!0}var m=/^\.orga\s+(\w+)$/i;function b(n){var t=n.line.match(m);if(null===t)return!1;var e=t[1],r=i(e);if(null===r)throw new Error("Could not parse .orga immediate "+e);return n.outIndex=r>>>0,!0}var g=/^\.align\s+([-\w]+)$/i;function y(n){var t=n.line.match(g);if(null===t)return!1;var e=t[1],s=i(e);if(null===s)throw new Error("Could not parse .align immediate "+e);if(s%2)throw new Error(".align directive requires a power of two.");if(s<0)throw new Error(".align directive cannot align by a negative value.");for(;n.outIndex%s;)n.currentPass===r.secondPass&&n.dataView.setUint8(n.outIndex,0),n.outIndex++;return!0}var h=/^\.skip\s+([-\w]+)$/i;function w(n){var t=n.line.match(h);if(null===t)return!1;var e=t[1],r=i(e);if(null===r)throw new Error("Could not parse .skip immediate "+e);if(r<0)throw new Error(".skip directive cannot skip a negative length.");return n.outIndex+=r,!0}var v=/^\.fill\s+([-\w]+)$/i,O=/^\.fill\s+([-\w]+),\s*([-\w]+)$/i;function E(n){var t,e,s,a,o=n.line.match(v);if(o)t=o[1];else{if(!(o=n.line.match(O)))return!1;t=o[1],s=o[2]}if(null===(e=i(t)))throw new Error("Could not parse .fill length "+t);if(e<0)throw new Error(".fill length must be positive.");if(s){if(null===(a=i(s)))throw new Error("Could not parse .fill value "+s)}else a=0;if(n.currentPass===r.secondPass)for(var f=0;f<e;f++)n.dataView.setInt8(n.outIndex+f,a);return n.outIndex+=e,!0}var P=/^\.ascii\s+([\\'\",-\w\s]+)$/i,x=/^\.asciiz\s+([\\'\",-\w\s]+)$/i;function D(n){var t=!1,e=n.line.match(P);if(!e){if(!(e=n.line.match(x)))return!1;t=!0}for(var s=e[1],a=[],o="",f="",l=!1,u=0;u<s.length;u++){var _=s[u];if(!l&&!f){if("\\"===_){l=!0;continue}if('"'===_||"'"===_){if(f)throw new Error("Encountered string during parsing of number: "+f);if(o&&o===_){o="";continue}if(!o){o=_;continue}}}if(l=!1,o)a.push(s.charCodeAt(u));else if(/[,\s]+/.test(_)){if(f){if(null===(c=i(f)))throw new Error("Could not parse immediate "+f);a.push(c)}f=""}else f+=_}if(o)throw new Error("Unterminated string: "+s);if(f){var c;if(null===(c=i(f)))throw new Error("Could not parse immediate "+f);a.push(c)}if(t&&a.push(0),n.currentPass===r.secondPass)for(u=0;u<a.length;u++)a[u]<0?n.dataView.setInt8(n.outIndex+u,a[u]):n.dataView.setUint8(n.outIndex+u,a[u]);return n.outIndex+=a.length,!0}var k=/^\.byte\s+([,-\w\s\(\)]+)$/i,M=/^\.db\s+([,-\w\s\(\)]+)$/i;function I(n){var t=n.line.match(k);if(!t&&!(t=n.line.match(M)))return!1;var e=t[1].split(",").map(function(n){return n.trim()}).filter(function(n){return!!n});if(n.currentPass===r.secondPass)for(var s=e.map(function(n){var t=i(n);if(null===t)throw new Error("Could not parse .byte immediate "+n);return t}),a=0;a<s.length;a++)s[a]<0?n.dataView.setInt8(n.outIndex+a,s[a]):n.dataView.setUint8(n.outIndex+a,s[a]);return n.outIndex+=e.length,!0}var j=/^\.halfword\s+([,-\w\s\(\)]+)$/i,B=/^\.dh\s+([,-\w\s\(\)]+)$/i;function L(n){var t=n.line.match(j);if(!t&&!(t=n.line.match(B)))return!1;var e=t[1].split(",").map(function(n){return n.trim()}).filter(function(n){return!!n});if(n.currentPass===r.secondPass)for(var s=e.map(function(n){var t=i(n);if(null===t)throw new Error("Could not parse .halfword immediate "+n);return t}),a=0;a<s.length;a++)s[a]<0?n.dataView.setInt16(n.outIndex+2*a,s[a]):n.dataView.setUint16(n.outIndex+2*a,s[a]);return n.outIndex+=2*e.length,!0}var R=/^\.word\s+([,-\w\s\(\)]+)$/i,S=/^\.dw\s+([,-\w\s\(\)]+)$/i;function C(n){var t=n.line.match(R);if(!t&&!(t=n.line.match(S)))return!1;var e=t[1].split(",").map(function(n){return n.trim()}).filter(function(n){return!!n});if(n.currentPass===r.secondPass)for(var s=e.map(function(n){var t=i(n);if(null===t)throw new Error("Could not parse .word immediate "+n);return t}),a=0;a<s.length;a++)s[a]<0?n.dataView.setInt32(n.outIndex+4*a,s[a]):n.dataView.setUint32(n.outIndex+4*a,s[a]);return n.outIndex+=4*e.length,!0}var U=/^\.float\s+([,-\.\w\s\(\)]+)$/i;function A(n){var t=n.line.match(U);if(!t)return!1;var e=t[1].split(",").map(function(n){return n.trim()}).filter(function(n){return!!n});if(n.currentPass===r.secondPass)for(var s=e.map(function(n){var t=parseFloat(n);if(null===t)throw new Error("Could not parse .float immediate "+n);return t}),i=0;i<s.length;i++)n.dataView.setFloat32(n.outIndex+4*i,s[i]);return n.outIndex+=4*e.length,!0}function T(n){if(![c,d,b,y,w,E,D,I,L,C,A].some(function(t){return t(n)}))throw new Error("handleDirective: Unrecongized directive "+n.line)}function W(n,t){var e=function n(t,e,r){var s=/^(\w+)\(([\(\),\w]*)\)$/.exec(t);if(null===s){var a=null;if(r&&null!==(a=i(t)))return a;var o=u(e,t);return null!==o?o:null}var f=s[1],l=s[2];if(!F[f]){var o=u(e,f);return null!==o?o:null}return F[f](e,n(l,e,!0))}(n,t,!1);return null!==e?function(n){var t=0===n,e=n<0,r=n.toString(16).toUpperCase();return e&&(r=r.substr(1)),(e?"-":"")+(t?"":"0x")+r}(e):null}var F=Object.create(null);function q(n,t){t=t||{};var e=function(n){if("string"==typeof n)return n.split(/\r?\n/);if(!Array.isArray(n))throw new Error("Input must be a string or array of strings");return n}(n);e=(e=(e=function(n){return n.map(function(n){var t=n.indexOf(";"),e=n.indexOf("//");if(-1===t&&-1===e)return n;var r=t;return-1===r?r=e:-1!==e&&(r=Math.min(t,e)),n.substr(0,r)})}(e=e.filter(function(n){return"string"==typeof n}))).map(function(n){return n.trim()})).filter(Boolean);var i={buffer:null,dataView:null,line:"",memPos:0,outIndex:0,symbols:Object.create(null),symbolsByValue:Object.create(null),currentLabel:null,localSymbols:Object.create(null),currentPass:r.firstPass},o=[];return e=(e=e.map(function(n){if(i.line=n,"."===n[0])return T(i),n;for(var t;t=a(i);)i.line=n=n.substr(t.length+1).trim();return n&&(i.outIndex+=4),n})).filter(Boolean),i.buffer=t.buffer||new ArrayBuffer(i.outIndex),i.dataView=new DataView(i.buffer),i.memPos=0,i.outIndex=0,i.currentPass=r.secondPass,e.forEach(function(n){if(i.line=n,"."===n[0])return n=K(i),void T(i);var e=function(n,t){return n.symbolsByValue[t]||null}(i,i.memPos+i.outIndex);null!==e&&(i.currentLabel=e),n=K(i),t.text&&o.push(n);var r=Object(s.parse)(n);i.dataView.setUint32(i.outIndex,r),i.outIndex+=4}),t.text?o:i.buffer}function K(n){var t=n.line,e=t.split(/[,\s]+/g);if(e.length>1){var r=W(e[e.length-1],n);null!==r&&(r=function(n,t,e){if(function(n){if("b"!==(n=n.toLowerCase())[0])return!1;switch(n){case"bc1f":case"bc1fl":case"bc1t":case"bc1tl":case"beq":case"beql":case"bgez":case"bgezal":case"bgezall":case"bgezl":case"bgtz":case"bgtzl":case"blez":case"blezl":case"bltz":case"bltzal":case"bltzall":case"bltzl":case"bne":case"bnel":return!0}return!1}(n)){var r=i(t),s=e.memPos+e.outIndex,a=(r-s)/4-1;return a.toString()}return t}(e[0],r,n),e[e.length-1]=r,t=n.line=e.join(" "))}return t}F.hi=function(n,t){var e=t>>>16;return 32768&(65535&t)&&(e+=1),e},F.lo=function(n,t){return 65535&t},F.org=function(n,t){return n.memPos+n.outIndex},e.d(t,"assemble",function(){return q})}])});