...
/*!*********************!*\
  !*** ./src/regs.js ***!
  \*********************/
/*! exports provided: getRegBits, getRegName, getFloatRegName, getFmtBits, getFmtName, getFmt3Bits, getFmt3Name, isFmtString, getCondBits, getCondName, isCondString */function(module,__webpack_exports__,__webpack_require__){"use strict";eval('__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getRegBits", function() { return getRegBits; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getRegName", function() { return getRegName; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getFloatRegName", function() { return getFloatRegName; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getFmtBits", function() { return getFmtBits; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getFmtName", function() { return getFmtName; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getFmt3Bits", function() { return getFmt3Bits; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getFmt3Name", function() { return getFmt3Name; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "isFmtString", function() { return isFmtString; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getCondBits", function() { return getCondBits; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getCondName", function() { return getCondName; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "isCondString", function() { return isCondString; });\nconst regs = {\n  r0: 0,\n  zero: 0,\n  at: 1,\n  v0: 2,\n  v1: 3,\n  a0: 4,\n  a1: 5,\n  a2: 6,\n  a3: 7,\n  t0: 8,\n  t1: 9,\n  t2: 10,\n  t3: 11,\n  t4: 12,\n  t5: 13,\n  t6: 14,\n  t7: 15,\n  s0: 16,\n  s1: 17,\n  s2: 18,\n  s3: 19,\n  s4: 20,\n  s5: 21,\n  s6: 22,\n  s7: 23,\n  t8: 24,\n  t9: 25,\n  k0: 26,\n  k1: 27,\n  gp: 28,\n  sp: 29,\n  fp: 30,\n  ra: 31\n};\n\nfunction getRegBits(reg) {\n  if (!reg)\n    return undefined;\n  return regs[reg.toLowerCase()];\n}\n\nfunction getRegName(bits) {\n  for (let name in regs) {\n    if (regs[name] === bits)\n      return name;\n  }\n  return "";\n}\n\nfunction getFloatRegName(bits) {\n  if (typeof bits !== "number")\n    throw new Error("getFloatRegName encountered non-number");\n\n  return "F" + bits;\n}\n\nconst fmts = {\n  S: 16,\n  D: 17,\n  W: 20,\n  L: 21,\n};\n\nfunction getFmtBits(fmtStr) {\n  return fmts[fmtStr.toUpperCase()];\n}\n\nfunction getFmtName(bits) {\n  for (let name in fmts) {\n    if (fmts[name] === bits)\n      return name;\n  }\n  return "";\n}\n\nconst fmt3s = {\n  S: 0,\n  D: 1,\n  W: 4,\n  L: 5,\n};\n\nfunction getFmt3Bits(fmtStr) {\n  return fmt3s[fmtStr.toUpperCase()];\n}\n\nfunction getFmt3Name(bits) {\n  for (let name in fmt3s) {\n    if (fmt3s[name] === bits)\n      return name;\n  }\n  return "";\n}\n\nfunction isFmtString(fmtStr) {\n  return fmts.hasOwnProperty(fmtStr.toUpperCase()) || fmt3s.hasOwnProperty(fmtStr.toUpperCase());\n}\n\nconst conds = {\n  F: 0,\n  UN: 1,\n  EQ: 2,\n  UEQ: 3,\n  OLT: 4,\n  ULT: 5,\n  OLE: 6,\n  ULE: 7,\n  SF: 8,\n  NGLE: 9,\n  SEQ: 10,\n  NGL: 11,\n  LT: 12,\n  NGE: 13,\n  LE: 14,\n  NGT: 15,\n};\n\nfunction getCondBits(condStr) {\n  return conds[condStr.toUpperCase()];\n}\n\nfunction getCondName(bits) {\n  for (let name in conds) {\n    if (conds[name] === bits)\n      return name;\n  }\n  return "";\n}\n\nfunction isCondString(condStr) {\n  return conds.hasOwnProperty(condStr.toUpperCase());\n}\n\n\n//# sourceURL=webpack://MIPSInst/./src/regs.js?')}})})},function(n,e,t){"use strict";t.r(e);var r,i=t(0);!function(n){n[n.firstPass=0]="firstPass",n[n.secondPass=1]="secondPass"}(r||(r={}));var s=new RegExp("^((?:@@)?[\\w\\?\\!]+)\\:");function a(n){var e=n.line.match(s);if(null===e)return!1;var t=e[1];if(o(t)){if(!n.currentLabel)throw new Error("Local label "+t+" (starts with @@) cannot be used before a global label");!function(n,e,t){var r=n.localSymbols[n.currentLabel];r||(r=n.localSymbols[n.currentLabel]=Object.create(null));r[e]=t}(n,t,f(n))}else n.currentLabel=t,c(n,t,f(n));return t}function o(n){return 0===n.indexOf("@@")}function f(n){return n.memPos+n.outIndex>>>0}function c(n,e,t){n.symbols[e]=t,n.symbolsByValue[t]=e,n.symbolOutputMap&&(n.symbolOutputMap[e]=n.outIndex)}function l(n,e){if(o(e)){if(!n.currentLabel)throw new Error("Local label "+e+" cannot be referenced in the current scope");var t=n.localSymbols[n.currentLabel];return t&&Object.prototype.hasOwnProperty.call(t,e)?t[e]:null}return Object.prototype.hasOwnProperty.call(n.symbols,e)?n.symbols[e]:null}function u(n,e){return function n(e,t){var r=p.exec(e);if(null===r){var i=function(n){if("string"!=typeof n)return null;var e,t="-"===n[0];return t&&(n=n.substr(1)),e="b"===n[0]||"0"===n[0]&&"b"===n[1]?parseInt(n.substr(2),2):"o"===n[0]||"0"===n[0]&&"o"===n[1]?parseInt(n.substr(2),8):"x"===n[0]||"0"===n[0]&&"x"===n[1]?parseInt(n.substr(2),16):parseInt(n,10),isNaN(e)?null:(t&&(e=-e),e)}(e);if(null!==i)return i;var s=function(n){if(n.length<2)return null;var e=n[0];if(n[n.length-1]!==e)return null;if('"'!==e&&"'"!==e)return null;for(var t="",r=1;r<n.length-1;r++){var i=n[r];if("\\"===i){var s=n[r+1];switch(s){case"\\":case'"':case"'":t+=s,r++;continue}}t+=i}return t}(e);if("string"==typeof s)return s;var a=l(t,e);return null!==a?a:null}var o=r[1];if(!_[o]){var a=l(t,o);return null!==a?a:null}var f="",c=0,u=void 0;for(u=o.length+1;u<e.length-1;u++){var d=e[u];if("("===d)c++;else if(")"===d&&--c<0){u++;break}f+=d}var m=void 0;return u<e.length-1?(m=e.substring(u,e.length),_[o](t,n(f,t))+m):_[o](t,n(f,t))}(n,e)}var p=new RegExp("^(\\w+)\\(([\\(\\),\\w\\?\\!]*)\\)$","i");var _=Object.create(null);_.hi=function(n,e){if("string"==typeof e)throw new Error('Assembler function hi cannot be called with string "'+e+'", value must be a number.');var t=e>>>16;return 32768&(65535&e)&&(t+=1),t},_.lo=function(n,e){if("string"==typeof e)throw new Error('Assembler function lo cannot be called with string "'+e+'", value must be a number.');return 65535&e},_.org=function(n,e){return n.memPos+n.outIndex};var d=new RegExp("^\\.definelabel\\s+((?:@@)?[\\w\\?\\!]+)[\\s,]+([-\\w\\?\\!]+)$","i");function m(n){if(null===n.line.match(d))return!1;if(2!==n.lineExpressions.length)throw new Error(".definelabel must have two arguments, a label name and value");var e=n.lineExpressions[0],t=u(n.lineExpressions[1],n);if("number"!=typeof t)throw new Error("The value in .definelabel must evaluate to a numeric value");return c(n,e,t),!0}var g=/^\.org\s+/i;function b(n){if(null===n.line.match(g))return!1;if(1!==n.lineExpressions.length)throw new Error(".org directive requires one numeric argument");var e=u(n.lineExpressions[0],n);if("number"!=typeof e)throw new Error("Could not parse .org immediate "+e);if(e<0)throw new Error(".org directive cannot be negative");return n.memPos=e>>>0,!0}var y=/^\.orga\s+/i;function h(n){if(null===n.line.match(y))return!1;if(1!==n.lineExpressions.length)throw new Error(".orga directive requires one numeric argument");var e=u(n.lineExpressions[0],n);if("number"!=typeof e)throw new Error("Could not parse .orga immediate "+e);if(e<0)throw new Error(".orga directive cannot be negative.");return n.outIndex=e>>>0,!0}var w=/^\.align\s+/i;function E(n){if(null===n.line.match(w))return!1;if(1!==n.lineExpressions.length)throw new Error(".align requires one power of two number argument");var e=u(n.lineExpressions[0],n);if(null===e)throw new Error("Could not parse .align immediate "+n.lineExpressions);if("number"!=typeof e)throw new Error(".align requires one power of two number argument");if(e%2)throw new Error(".align directive requires a power of two.");if(e<0)throw new Error(".align directive cannot align by a negative value.");for(;n.outIndex%e;)n.currentPass===r.secondPass&&n.dataView.setUint8(n.outIndex,0),n.outIndex++;return!0}var v=/^\.skip\s+/i;function O(n){if(null===n.line.match(v))return!1;if(1!==n.lineExpressions.length)throw new Error(".skip directive requires one numeric argument");var e=u(n.lineExpressions[0],n);if("number"!=typeof e)throw new Error("Could not parse .skip immediate "+e);if(e<0)throw new Error(".skip directive cannot skip a negative length.");return n.outIndex+=e,!0}var x=/^\.fill\s+/i;function k(n){var e,t;if(null===n.line.match(x))return!1;if(!n.lineExpressions.length||n.lineExpressions.length>2)throw new Error(".fill directive takes a length and optional value");if("number"!=typeof(e=u(n.lineExpressions[0],n)))throw new Error("Could not parse .fill length "+n.lineExpressions[0]);if(e<0)throw new Error(".fill length must be positive.");if(n.lineExpressions.length>1){if("number"!=typeof(t=u(n.lineExpressions[1],n)))throw new Error("Could not parse .fill value "+n.lineExpressions[1])}else t=0;if(n.currentPass===r.secondPass)for(var i=0;i<e;i++)n.dataView.setInt8(n.outIndex+i,t);return n.outIndex+=e,!0}var P=/^\.ascii\s+/i,D=/^\.asciiz\s+/i;function B(n){var e=!1,t=n.line.match(P);if(!t){if(!(t=n.line.match(D)))return!1;e=!0}var i=[];if(n.lineExpressions.forEach(function(e){var t=u(e,n);if(null===t)throw new Error("Could not parse .ascii value "+e);if("number"==typeof t)i.push(t);else if("string"==typeof t)for(var r=0;r<t.length;r++)i.push(t.charCodeAt(r))}),e&&i.push(0),n.currentPass===r.secondPass)for(var s=0;s<i.length;s++)i[s]<0?n.dataView.setInt8(n.outIndex+s,i[s]):n.dataView.setUint8(n.outIndex+s,i[s]);return n.outIndex+=i.length,!0}var M=",-\\w\\s\\(\\)\\?\\!";function I(n){var e=n.line,t=e.indexOf(" ");if(-1===t)return e;var r=e.substring(0,t),i=j(e.substr(t+1));if(n.lineExpressions=i,i.length>0){var s=i.map(function(e,t){var s=u(e,n);return"number"==typeof s&&t===i.length-1&&(s=function(n,e,t){if(function(n){if("b"!==(n=n.toLowerCase())[0])return!1;switch(n){case"bc1f":case"bc1fl":case"bc1t":case"bc1tl":case"beq":case"beql":case"bgez":case"bgezal":case"bgezall":case"bgezl":case"bgtz":case"bgtzl":case"blez":case"blezl":case"bltz":case"bltzal":case"bltzall":case"bltzl":case"bne":case"bnel":return!0}return!1}(n)){var r=t.memPos+t.outIndex,i=(e-r)/4-1;return i}return e}(r,s,n)),s});n.evaluatedLineExpressions=s,e=r+" "+function(n,e){return n.map(function(n,t){return"number"==typeof n?function(n){var e=0===n,t=n<0,r=n.toString(16).toUpperCase();return t&&(r=r.substr(1)),(t?"-":"")+(e?"":"0x")+r}(n):null===n?e[t]:n})}(s,i).join(" ")}return e}function j(n){var e=[],t="",r="",i=0,s=!1,a="";function o(n){t+=n}function f(){for(;L(t[t.length-1]);)t=t.slice(0,-1);(t=t.trim())&&(e.push(t),t="")}for(var c=0;c<n.length;c++){var l=n[c];switch(r||i||L(a)&&f(),l){case"\\":s||(s=!0);break;case"(":s||r||i++;break;case")":if(!s&&!r){if(i<=0)throw new Error("Imbalanced parenthesis in expression: "+n);i--}break;case'"':case"'":s||(r?r===l&&(r=""):r=l)}o(l),"\\"!==l&&(s=!1),a=l}if(i>0)throw new Error("Imbalanced parenthesis in expression: "+n);if(r)throw new Error("Unterminated string: "+t);return f(),e}function L(n){return","===n||function(n){return" "===n||"\t"===n}(n)}function S(n,e){return new RegExp("^\\."+n+(e?"":"\\s+"),"i")}function R(n){return new RegExp("^\\."+n+"\\s+(["+M+"]+)$","i")}var C=R("byte"),A=R("db");function U(n){var e=n.line.match(C);if(!e&&!(e=n.line.match(A)))return!1;if(n.currentPass===r.secondPass){if(!n.evaluatedLineExpressions.length)throw new Error(".byte directive requires arguments");if(n.evaluatedLineExpressions.some(function(n){return"number"!=typeof n}))throw new Error(".byte directive requires numeric arguments");for(var t=n.evaluatedLineExpressions,i=0;i<t.length;i++)t[i]<0?n.dataView.setInt8(n.outIndex+i,t[i]):n.dataView.setUint8(n.outIndex+i,t[i])}return n.outIndex+=n.lineExpressions.length,!0}var q=R("halfword"),T=R("dh");function W(n){var e=n.line.match(q);if(!e&&!(e=n.line.match(T)))return!1;if(n.currentPass===r.secondPass){if(!n.evaluatedLineExpressions.length)throw new Error(".halfword directive requires arguments");if(n.evaluatedLineExpressions.some(function(n){return"number"!=typeof n}))throw new Error(".halfword directive requires numeric arguments");for(var t=n.evaluatedLineExpressions,i=0;i<t.length;i++)t[i]<0?n.dataView.setInt16(n.outIndex+2*i,t[i]):n.dataView.setUint16(n.outIndex+2*i,t[i])}return n.outIndex+=2*n.lineExpressions.length,!0}var F=R("word"),K=R("dw");function N(n){var e=n.line.match(F);if(!e&&!(e=n.line.match(K)))return!1;if(n.currentPass===r.secondPass){if(!n.evaluatedLineExpressions.length)throw new Error(".word directive requires arguments");if(n.evaluatedLineExpressions.some(function(n){return"number"!=typeof n}))throw new Error(".word directive requires numeric arguments");for(var t=n.evaluatedLineExpressions,i=0;i<t.length;i++)t[i]<0?n.dataView.setInt32(n.outIndex+4*i,t[i]):n.dataView.setUint32(n.outIndex+4*i,t[i])}return n.outIndex+=4*n.lineExpressions.length,!0}var V,z=/^\.float\s+([,-\.\w\s\(\)]+)$/i;function $(n){var e=n.line.match(z);if(!e)return!1;var t=e[1].split(",").map(function(n){return n.trim()}).filter(function(n){return!!n});if(n.currentPass===r.secondPass)for(var i=t.map(function(n){var e=parseFloat(n);if(null===e)throw new Error("Could not parse .float immediate "+n);return e}),s=0;s<i.length;s++)n.dataView.setFloat32(n.outIndex+4*s,i[s]);return n.outIndex+=4*t.length,!0}!function(n){n[n.None=0]="None",n[n.AcceptingBlock=1]="AcceptingBlock",n[n.ExecutingBlock=2]="ExecutingBlock",n[n.NoLongerAcceptingBlock=4]="NoLongerAcceptingBlock",n[n.SawElse=8]="SawElse"}(V||(V={}));var G=V.AcceptingBlock|V.ExecutingBlock|V.NoLongerAcceptingBlock;function Q(n,e){n.ifElseStack[n.ifElseStack.length-1]&=~G,n.ifElseStack[n.ifElseStack.length-1]|=e}var Z=S("if");function H(n){if(!n.line.match(Z))return!1;if(!n.lineExpressions.length)throw new Error("A condition must be passed to an if directive");if(n.lineExpressions.length>1)throw new Error("Only a single condition can be passed to an if directive");var e=u(n.lineExpressions[0],n);if(null===e)throw new Error("Could not parse .if condition");if("number"!=typeof e)throw new Error("Condition of if directive must evaluate to a numeric value, saw: "+e);return e?n.ifElseStack.push(V.ExecutingBlock):n.ifElseStack.push(V.AcceptingBlock),!0}var J=S("else",!0);function X(n){if(!n.line.match(J))return!1;if(n.lineExpressions.length)throw new Error("The else directive cannot take a condition or parameters");if(!n.ifElseStack.length)throw new Error("An else directive was reached, but there was no previous if directive");var e=n.ifElseStack[n.ifElseStack.length-1];if(e&V.SawElse)throw new Error("Encountered another else directive, but an else directive was already passed");switch(e&G){case V.AcceptingBlock:Q(n,V.ExecutingBlock);break;case V.ExecutingBlock:Q(n,V.NoLongerAcceptingBlock);break;case V.NoLongerAcceptingBlock:break;default:throw new Error("Unexpected conditional block state: "+e.toString(16))}return n.ifElseStack[n.ifElseStack.length-1]|=V.SawElse,!0}var Y=S("elseif");function nn(n){if(!n.line.match(Y))return!1;if(!n.lineExpressions.length)throw new Error("A condition must be passed to an elseif directive");if(n.lineExpressions.length>1)throw new Error("Only a single condition can be passed to an elseif directive");if(!n.ifElseStack.length)throw new Error("An elseif directive was reached, but there was no previous if directive");var e=n.ifElseStack[n.ifElseStack.length-1];if(e&V.SawElse)throw new Error("Encountered an elseif after seeing an else directive");var t=u(n.lineExpressions[0],n);if(null===t)throw new Error("Could not parse .elseif condition");if("number"!=typeof t)throw new Error("Condition of elseif directive must evaluate to a numeric value, saw: "+t);switch(e&G){case V.AcceptingBlock:t&&Q(n,V.ExecutingBlock);break;case V.ExecutingBlock:Q(n,V.NoLongerAcceptingBlock);break;case V.NoLongerAcceptingBlock:break;default:throw new Error("Unexpected conditional block state: "+e.toString(16))}return!0}var en=S("endif",!0);function tn(n){if(!n.line.match(en))return!1;if(n.lineExpressions.length)throw new Error("The endif directive cannot take a condition or parameters");if(!n.ifElseStack.length)throw new Error("An endif directive was reached, but there was no previous if directive");return n.ifElseStack.pop(),!0}function rn(n){if(![m,b,h,E,O,k,B,U,W,N,$,H,nn,X,tn].some(function(e){return e(n)}))throw new Error("handleDirective: Unrecongized directive "+n.line)}function sn(n,e){return n.substr(0,e.length)===e}function an(n,e){e=e||{};var t=function(n){if("string"==typeof n)return n.split(/\r?\n/);if(!Array.isArray(n))throw new Error("Input must be a string or array of strings");return n}(n);t=(t=(t=function(n){return n.map(function(n){var e=n.indexOf(";"),t=n.indexOf("//");if(-1===e&&-1===t)return n;var r=e;return-1===r?r=t:-1!==t&&(r=Math.min(e,t)),n.substr(0,r)})}(t=t.filter(function(n){return"string"==typeof n}))).map(function(n){return n.trim()})).filter(Boolean);var s=function(n){return{buffer:null,dataView:null,line:"",memPos:0,outIndex:0,symbols:Object.create(null),symbolsByValue:Object.create(null),symbolOutputMap:n.symbolOutputMap,currentLabel:null,localSymbols:Object.create(null),currentPass:r.firstPass,lineExpressions:[],evaluatedLineExpressions:null,ifElseStack:[]}}(e),o=[];if(t=(t=t.map(function(n){return s.line=n,on(s)?n:"."===(n=function(n){var e;for(;e=a(n);)n.line=n.line.substr(e.length+1).trim();return n.line}(s))[0]?(function(n){var e=n.line,t=e.indexOf(" ");if(-1!==t){var r=j(e.substr(t+1));n.lineExpressions=r}else n.lineExpressions=[]}(s),rn(s),n):(n&&(s.outIndex+=4),n)})).filter(Boolean),s.buffer=e.buffer||new ArrayBuffer(s.outIndex),s.dataView=new DataView(s.buffer),s.memPos=0,s.outIndex=0,s.currentPass=r.secondPass,t.forEach(function(n){if(s.line=n,s.lineExpressions=[],s.evaluatedLineExpressions=[],on(s))return n;if("."===n[0])return I(s),void rn(s);var t=function(n,e){return n.symbolsByValue[e]||null}(s,s.memPos+s.outIndex);null!==t&&(s.currentLabel=t),n=s.line=I(s),e.text&&o.push(n);var r=Object(i.parse)(n);s.dataView.setUint32(s.outIndex,r),s.outIndex+=4}),s.ifElseStack.length)throw new Error("An if directive was used without an endif directive");return e.text?o:s.buffer}function on(n){return!!n.ifElseStack.length&&!(n.ifElseStack[n.ifElseStack.length-1]&V.ExecutingBlock||function(n){var e=n.toLowerCase();return sn(e,".if")||sn(e,".else")||sn(e,".endif")}(n.line))}t.d(e,"assemble",function(){return an})}])});