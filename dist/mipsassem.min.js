...
/*!*********************!*\
  !*** ./src/regs.js ***!
  \*********************/
/*! exports provided: getRegBits, getRegName, getFloatRegName, getFmtBits, getFmtName, getFmt3Bits, getFmt3Name, isFmtString, getCondBits, getCondName, isCondString */function(module,__webpack_exports__,__webpack_require__){"use strict";eval('__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getRegBits", function() { return getRegBits; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getRegName", function() { return getRegName; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getFloatRegName", function() { return getFloatRegName; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getFmtBits", function() { return getFmtBits; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getFmtName", function() { return getFmtName; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getFmt3Bits", function() { return getFmt3Bits; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getFmt3Name", function() { return getFmt3Name; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "isFmtString", function() { return isFmtString; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getCondBits", function() { return getCondBits; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getCondName", function() { return getCondName; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "isCondString", function() { return isCondString; });\nconst regs = {\n  r0: 0,\n  zero: 0,\n  at: 1,\n  v0: 2,\n  v1: 3,\n  a0: 4,\n  a1: 5,\n  a2: 6,\n  a3: 7,\n  t0: 8,\n  t1: 9,\n  t2: 10,\n  t3: 11,\n  t4: 12,\n  t5: 13,\n  t6: 14,\n  t7: 15,\n  s0: 16,\n  s1: 17,\n  s2: 18,\n  s3: 19,\n  s4: 20,\n  s5: 21,\n  s6: 22,\n  s7: 23,\n  t8: 24,\n  t9: 25,\n  k0: 26,\n  k1: 27,\n  gp: 28,\n  sp: 29,\n  fp: 30,\n  ra: 31\n};\n\nfunction getRegBits(reg) {\n  if (!reg)\n    return undefined;\n  return regs[reg.toLowerCase()];\n}\n\nfunction getRegName(bits) {\n  for (let name in regs) {\n    if (regs[name] === bits)\n      return name;\n  }\n  return "";\n}\n\nfunction getFloatRegName(bits) {\n  if (typeof bits !== "number")\n    throw new Error("getFloatRegName encountered non-number");\n\n  return "F" + bits;\n}\n\nconst fmts = {\n  S: 16,\n  D: 17,\n  W: 20,\n  L: 21,\n};\n\nfunction getFmtBits(fmtStr) {\n  return fmts[fmtStr.toUpperCase()];\n}\n\nfunction getFmtName(bits) {\n  for (let name in fmts) {\n    if (fmts[name] === bits)\n      return name;\n  }\n  return "";\n}\n\nconst fmt3s = {\n  S: 0,\n  D: 1,\n  W: 4,\n  L: 5,\n};\n\nfunction getFmt3Bits(fmtStr) {\n  return fmt3s[fmtStr.toUpperCase()];\n}\n\nfunction getFmt3Name(bits) {\n  for (let name in fmt3s) {\n    if (fmt3s[name] === bits)\n      return name;\n  }\n  return "";\n}\n\nfunction isFmtString(fmtStr) {\n  return fmts.hasOwnProperty(fmtStr.toUpperCase()) || fmt3s.hasOwnProperty(fmtStr.toUpperCase());\n}\n\nconst conds = {\n  F: 0,\n  UN: 1,\n  EQ: 2,\n  UEQ: 3,\n  OLT: 4,\n  ULT: 5,\n  OLE: 6,\n  ULE: 7,\n  SF: 8,\n  NGLE: 9,\n  SEQ: 10,\n  NGL: 11,\n  LT: 12,\n  NGE: 13,\n  LE: 14,\n  NGT: 15,\n};\n\nfunction getCondBits(condStr) {\n  return conds[condStr.toUpperCase()];\n}\n\nfunction getCondName(bits) {\n  for (let name in conds) {\n    if (conds[name] === bits)\n      return name;\n  }\n  return "";\n}\n\nfunction isCondString(condStr) {\n  return conds.hasOwnProperty(condStr.toUpperCase());\n}\n\n\n//# sourceURL=webpack://MIPSInst/./src/regs.js?')}})})},function(n,e,t){"use strict";t.r(e);var r,i=t(0);!function(n){n[n.firstPass=0]="firstPass",n[n.secondPass=1]="secondPass"}(r||(r={}));var s=new RegExp("^(@?@?[\\w\\?\\!]+)\\:");function a(n){var e=n.line.match(s);if(null===e)return!1;var t=e[1];if(o(t)){if(!n.currentLabel)throw new Error("Local label "+t+" (starts with @@) cannot be used before a global label");!function(n,e,t){var r=n.localSymbols[n.currentLabel];r||(r=n.localSymbols[n.currentLabel]=Object.create(null));r[e]=t}(n,t,l(n))}else f(t)?function(n,e,t){n.staticSymbols[n.staticSymbols.length-1][e]=t}(n,t,l(n)):(n.currentLabel=t,c(n,t,l(n)));return t}function o(n){return 0===n.indexOf("@@")}function f(n){return 0===n.indexOf("@")&&"@"!==n[1]}function l(n){return n.memPos+n.outIndex>>>0}function c(n,e,t){n.symbols[e]=t,n.symbolsByValue[t]=e,n.symbolOutputMap&&(n.symbolOutputMap[e]=n.outIndex)}function u(n,e){if(o(e)){if(!n.currentLabel)throw new Error("Local label "+e+" cannot be referenced in the current scope");var t=n.localSymbols[n.currentLabel];return t&&Object.prototype.hasOwnProperty.call(t,e)?t[e]:null}if(f(e)){var r=n.staticSymbols[n.staticSymbolIndices[0]];return Object.prototype.hasOwnProperty.call(r,e)?r[e]:null}return Object.prototype.hasOwnProperty.call(n.symbols,e)?n.symbols[e]:null}function p(n,e){return function n(e,t){var r=_.exec(e);if(null===r){var i=function(n){if("string"!=typeof n)return null;var e,t="-"===n[0];return t&&(n=n.substr(1)),e="b"===n[0]||"0"===n[0]&&"b"===n[1]?parseInt(n.substr(2),2):"o"===n[0]||"0"===n[0]&&"o"===n[1]?parseInt(n.substr(2),8):"x"===n[0]||"0"===n[0]&&"x"===n[1]?parseInt(n.substr(2),16):parseInt(n,10),isNaN(e)?null:(t&&(e=-e),e)}(e);if(null!==i)return i;var s=function(n){if(n.length<2)return null;var e=n[0];if(n[n.length-1]!==e)return null;if('"'!==e&&"'"!==e)return null;for(var t="",r=1;r<n.length-1;r++){var i=n[r];if("\\"===i){var s=n[r+1];switch(s){case"\\":case'"':case"'":t+=s,r++;continue}}t+=i}return t}(e);if("string"==typeof s)return s;var a=u(t,e);return null!==a?a:null}var o=r[1];if(!d[o]){var a=u(t,o);return null!==a?a:null}var f="",l=0,c=void 0;for(c=o.length+1;c<e.length-1;c++){var p=e[c];if("("===p)l++;else if(")"===p&&--l<0){c++;break}f+=p}var m=void 0;return c<e.length-1?(m=e.substring(c,e.length),d[o](t,n(f,t))+m):d[o](t,n(f,t))}(n,e)}var _=new RegExp("^(\\w+)\\(([\\(\\),\\w\\?\\!\\@]*)\\)$","i");var d=Object.create(null);function m(n,e){throw new Error(n+"\nLine: "+e.line)}d.hi=function(n,e){if("string"==typeof e)throw new Error('Assembler function hi cannot be called with string "'+e+'", value must be a number.');var t=e>>>16;return 32768&(65535&e)&&(t+=1),t},d.lo=function(n,e){if("string"==typeof e)throw new Error('Assembler function lo cannot be called with string "'+e+'", value must be a number.');return 65535&e},d.org=function(n,e){return n.memPos+n.outIndex};var g=new RegExp("^\\.definelabel\\s+(@?@?[\\w\\?\\!]+)[\\s,]+([-\\w\\?\\!\\@]+)$","i");function b(n){if(null===n.line.match(g))return!1;2!==n.lineExpressions.length&&m(".definelabel must have two arguments, a label name and value",n);var e=n.lineExpressions[0],t=p(n.lineExpressions[1],n);return"number"!=typeof t?(m("The value in .definelabel must evaluate to a numeric value",n),!1):(c(n,e,t),!0)}var y=/^\.org\s+/i;function h(n){if(null===n.line.match(y))return!1;1!==n.lineExpressions.length&&m(".org directive requires one numeric argument",n);var e=p(n.lineExpressions[0],n);return"number"!=typeof e?(m("Could not parse .org immediate "+e,n),!1):(e<0&&m(".org directive cannot be negative",n),n.memPos=e>>>0,!0)}var v=/^\.orga\s+/i;function E(n){if(null===n.line.match(v))return!1;1!==n.lineExpressions.length&&m(".orga directive requires one numeric argument",n);var e=p(n.lineExpressions[0],n);return"number"!=typeof e?(m("Could not parse .orga immediate "+e,n),!1):(e<0&&m(".orga directive cannot be negative.",n),n.outIndex=e>>>0,!0)}var w=/^\.align\s+/i;function O(n){if(null===n.line.match(w))return!1;1!==n.lineExpressions.length&&m(".align requires one power of two number argument",n);var e=p(n.lineExpressions[0],n);if(null===e&&m("Could not parse .align immediate "+n.lineExpressions,n),"number"!=typeof e)return m(".align requires one power of two number argument",n),!1;for(e%2&&m(".align directive requires a power of two.",n),e<0&&m(".align directive cannot align by a negative value.",n);n.outIndex%e;)n.currentPass===r.secondPass&&n.dataView.setUint8(n.outIndex,0),n.outIndex++;return!0}var x=/^\.skip\s+/i;function k(n){if(null===n.line.match(x))return!1;1!==n.lineExpressions.length&&m(".skip directive requires one numeric argument",n);var e=p(n.lineExpressions[0],n);return"number"!=typeof e?(m("Could not parse .skip immediate "+e,n),!1):(e<0&&m(".skip directive cannot skip a negative length.",n),n.outIndex+=e,!0)}var P=/^\.fill\s+/i;function D(n){var e,t;if(null===n.line.match(P))return!1;if(!n.lineExpressions.length||n.lineExpressions.length>2)throw new Error(".fill directive takes a length and optional value");if("number"!=typeof(e=p(n.lineExpressions[0],n)))return m("Could not parse .fill length "+n.lineExpressions[0],n),!1;if(e<0&&m(".fill length must be positive.",n),n.lineExpressions.length>1){if("number"!=typeof(t=p(n.lineExpressions[1],n)))return m("Could not parse .fill value "+n.lineExpressions[1],n),!1}else t=0;if(n.currentPass===r.secondPass)for(var i=0;i<e;i++)n.dataView.setInt8(n.outIndex+i,t);return n.outIndex+=e,!0}var I=/^\.ascii\s+/i,M=/^\.asciiz\s+/i;function B(n){var e=!1,t=n.line.match(I);if(!t){if(!(t=n.line.match(M)))return!1;e=!0}var i=[];if(n.lineExpressions.forEach(function(e){var t=p(e,n);if(null===t&&m("Could not parse .ascii value "+e,n),"number"==typeof t)i.push(t);else if("string"==typeof t)for(var r=0;r<t.length;r++)i.push(t.charCodeAt(r))}),e&&i.push(0),n.currentPass===r.secondPass)for(var s=0;s<i.length;s++)i[s]<0?n.dataView.setInt8(n.outIndex+s,i[s]):n.dataView.setUint8(n.outIndex+s,i[s]);return n.outIndex+=i.length,!0}var j=",-\\w\\s\\(\\)\\?\\!\\@";function S(n){var e=n.line,t=e.indexOf(" ");if(-1!==t){var r=R(e.substr(t+1));n.lineExpressions=r}else n.lineExpressions=[]}function L(n){var e=n.line,t=e.indexOf(" ");if(-1===t)return e;var r=e.substring(0,t),i=R(e.substr(t+1));if(n.lineExpressions=i,i.length>0){var s=i.map(function(e,t){var s=p(e,n);return"number"==typeof s&&t===i.length-1&&(s=function(n,e,t){if(function(n){if("b"!==(n=n.toLowerCase())[0])return!1;switch(n){case"bc1f":case"bc1fl":case"bc1t":case"bc1tl":case"beq":case"beql":case"bgez":case"bgezal":case"bgezall":case"bgezl":case"bgtz":case"bgtzl":case"blez":case"blezl":case"bltz":case"bltzal":case"bltzall":case"bltzl":case"bne":case"bnel":return!0}return!1}(n)){var r=t.memPos+t.outIndex,i=(e-r)/4-1;return i}return e}(r,s,n)),s});n.evaluatedLineExpressions=s,e=r+" "+function(n,e){return n.map(function(n,t){return"number"==typeof n?function(n){var e=0===n,t=n<0,r=n.toString(16).toUpperCase();return t&&(r=r.substr(1)),(t?"-":"")+(e?"":"0x")+r}(n):null===n?e[t]:n})}(s,i).join(" ")}return e}function R(n){var e=[],t="",r="",i=0,s=!1,a="";function o(n){t+=n}function f(){for(;C(t[t.length-1]);)t=t.slice(0,-1);(t=t.trim())&&(e.push(t),t="")}for(var l=0;l<n.length;l++){var c=n[l];switch(r||i||C(a)&&f(),c){case"\\":s||(s=!0);break;case"(":s||r||i++;break;case")":if(!s&&!r){if(i<=0)throw new Error("Imbalanced parenthesis in expression: "+n);i--}break;case'"':case"'":s||(r?r===c&&(r=""):r=c)}o(c),"\\"!==c&&(s=!1),a=c}if(i>0)throw new Error("Imbalanced parenthesis in expression: "+n);if(r)throw new Error("Unterminated string: "+t);return f(),e}function C(n){return","===n||function(n){return" "===n||"\t"===n}(n)}function A(n,e){return new RegExp("^\\."+n+(e?"":"\\s+"),"i")}function U(n){return new RegExp("^\\."+n+"\\s+(["+j+"]+)$","i")}var T=U("byte"),q=U("db");function W(n){var e=n.line.match(T);if(!e&&!(e=n.line.match(q)))return!1;if(n.currentPass===r.secondPass){n.evaluatedLineExpressions.length||m(".byte directive requires arguments",n),n.evaluatedLineExpressions.some(function(n){return"number"!=typeof n})&&m(".byte directive requires numeric arguments",n);for(var t=n.evaluatedLineExpressions,i=0;i<t.length;i++)t[i]<0?n.dataView.setInt8(n.outIndex+i,t[i]):n.dataView.setUint8(n.outIndex+i,t[i])}return n.outIndex+=n.lineExpressions.length,!0}var F=U("halfword"),K=U("dh");function N(n){var e=n.line.match(F);if(!e&&!(e=n.line.match(K)))return!1;if(n.currentPass===r.secondPass){n.evaluatedLineExpressions.length||m(".halfword directive requires arguments",n),n.evaluatedLineExpressions.some(function(n){return"number"!=typeof n})&&m(".halfword directive requires numeric arguments",n);for(var t=n.evaluatedLineExpressions,i=0;i<t.length;i++)t[i]<0?n.dataView.setInt16(n.outIndex+2*i,t[i]):n.dataView.setUint16(n.outIndex+2*i,t[i])}return n.outIndex+=2*n.lineExpressions.length,!0}var V=U("word"),z=U("dw");function $(n){var e=n.line.match(V);if(!e&&!(e=n.line.match(z)))return!1;if(n.currentPass===r.secondPass){n.evaluatedLineExpressions.length||m(".word directive requires arguments",n),n.evaluatedLineExpressions.some(function(n){return"number"!=typeof n})&&m(".word directive requires numeric arguments",n);for(var t=n.evaluatedLineExpressions,i=0;i<t.length;i++)t[i]<0?n.dataView.setInt32(n.outIndex+4*i,t[i]):n.dataView.setUint32(n.outIndex+4*i,t[i])}return n.outIndex+=4*n.lineExpressions.length,!0}var G,Q=/^\.float\s+([,-\.\w\s\(\)]+)$/i;function Z(n){var e=n.line.match(Q);if(!e)return!1;var t=e[1].split(",").map(function(n){return n.trim()}).filter(function(n){return!!n});if(n.currentPass===r.secondPass)for(var i=t.map(function(e){var t=parseFloat(e);return null===t&&m("Could not parse .float immediate "+e,n),t}),s=0;s<i.length;s++)n.dataView.setFloat32(n.outIndex+4*s,i[s]);return n.outIndex+=4*t.length,!0}!function(n){n[n.None=0]="None",n[n.AcceptingBlock=1]="AcceptingBlock",n[n.ExecutingBlock=2]="ExecutingBlock",n[n.NoLongerAcceptingBlock=4]="NoLongerAcceptingBlock",n[n.SawElse=8]="SawElse"}(G||(G={}));var H=G.AcceptingBlock|G.ExecutingBlock|G.NoLongerAcceptingBlock;function J(n,e){n.ifElseStack[n.ifElseStack.length-1]&=~H,n.ifElseStack[n.ifElseStack.length-1]|=e}var X=A("if");function Y(n){if(!n.line.match(X))return!1;n.lineExpressions.length||m("A condition must be passed to an if directive",n),n.lineExpressions.length>1&&m("Only a single condition can be passed to an if directive",n);var e=p(n.lineExpressions[0],n);return null===e&&m("Could not parse .if condition",n),"number"!=typeof e&&m("Condition of if directive must evaluate to a numeric value, saw: "+e,n),e?n.ifElseStack.push(G.ExecutingBlock):n.ifElseStack.push(G.AcceptingBlock),!0}var nn=A("else",!0);function en(n){if(!n.line.match(nn))return!1;n.lineExpressions.length&&m("The else directive cannot take a condition or parameters",n),n.ifElseStack.length||m("An else directive was reached, but there was no previous if directive",n);var e=n.ifElseStack[n.ifElseStack.length-1];switch(e&G.SawElse&&m("Encountered another else directive, but an else directive was already passed",n),e&H){case G.AcceptingBlock:J(n,G.ExecutingBlock);break;case G.ExecutingBlock:J(n,G.NoLongerAcceptingBlock);break;case G.NoLongerAcceptingBlock:break;default:m("Unexpected conditional block state: "+e.toString(16),n)}return n.ifElseStack[n.ifElseStack.length-1]|=G.SawElse,!0}var tn=A("elseif");function rn(n){if(!n.line.match(tn))return!1;n.lineExpressions.length||m("A condition must be passed to an elseif directive",n),n.lineExpressions.length>1&&m("Only a single condition can be passed to an elseif directive",n),n.ifElseStack.length||m("An elseif directive was reached, but there was no previous if directive",n);var e=n.ifElseStack[n.ifElseStack.length-1];e&G.SawElse&&m("Encountered an elseif after seeing an else directive",n);var t=p(n.lineExpressions[0],n);switch(null===t&&m("Could not parse .elseif condition",n),"number"!=typeof t&&m("Condition of elseif directive must evaluate to a numeric value, saw: "+t,n),e&H){case G.AcceptingBlock:t&&J(n,G.ExecutingBlock);break;case G.ExecutingBlock:J(n,G.NoLongerAcceptingBlock);break;case G.NoLongerAcceptingBlock:break;default:m("Unexpected conditional block state: "+e.toString(16),n)}return!0}var sn=A("endif",!0);function an(n){return!!n.line.match(sn)&&(n.lineExpressions.length&&m("The endif directive cannot take a condition or parameters",n),n.ifElseStack.length||m("An endif directive was reached, but there was no previous if directive",n),n.ifElseStack.pop(),!0)}var on=A("include");function fn(n){if(!n.line.match(on))return!1;n.lineExpressions.length||m("A file name must be passed to an include directive",n),n.lineExpressions.length>1&&m("Only a single file name can be passed to an include directive",n);var e=p(n.lineExpressions[0],n);if(null===e&&m("Could not parse .include file name",n),"string"!=typeof e)return m("File name of include directive must evaluate to a string, saw: "+e,n),!1;var t=n.files[e];if("string"!=typeof t&&m("The "+e+" file was not a string",n),n.currentPass!==r.firstPass)throw Error("The `include` directive shouldn't be present after the first assembly phase");return n.linesToInsert=".beginfile\n"+t+"\n.endfile",n.line="",!0}var ln=A("beginfile",!0);function cn(n){return!!n.line.match(ln)&&(n.lineExpressions.length&&m("The beginfile directive takes no arguments",n),function(n){if(n.currentPass===r.firstPass){n.staticSymbols.push(Object.create(null));var e=n.staticSymbolIndices[n.staticSymbolIndices.length-1],t=n.staticSymbols.length-1;n.staticSymbolIndices.before[t]=e,n.staticSymbolIndices.push(t)}else n.staticSymbolIndices.shift()}(n),!0)}var un=A("endfile",!0);function pn(n){return!!n.line.match(un)&&(n.lineExpressions.length&&m("The endfile directive takes no arguments",n),function(n){if(n.currentPass===r.firstPass){var e=n.staticSymbolIndices;e.push(e.before[e[e.length-1]])}else n.staticSymbolIndices.shift()}(n),!0)}function _n(n){if(![b,h,E,O,k,D,B,W,N,$,Z,Y,rn,en,an,fn,cn,pn].some(function(e){return e(n)}))throw new Error("handleDirective: Unrecongized directive "+n.line)}function dn(n,e){return n.substr(0,e.length)===e}function mn(n,e){e=e||{};for(var t=yn(n),s=function(n){var e=[0];return e.before=Object.create(null),{buffer:null,dataView:null,line:"",memPos:0,outIndex:0,symbols:Object.create(null),symbolsByValue:Object.create(null),symbolOutputMap:n.symbolOutputMap,currentLabel:null,localSymbols:Object.create(null),staticSymbols:[Object.create(null)],staticSymbolIndices:e,currentPass:r.firstPass,lineExpressions:[],evaluatedLineExpressions:null,ifElseStack:[],files:n.files||Object.create(null),linesToInsert:null}}(e),a=[],o=[],f=0;f<t.length;f++){var l=t[f];if(s.line=l,gn(s))l&&o.push(l);else if("."===(l=bn(s))[0]?(S(s),_n(s),l=s.line):l&&(s.outIndex+=4),l&&o.push(l),"linesToInsert"in s&&s.linesToInsert){var c=yn(s.linesToInsert);t.splice.apply(t,[f+1,0].concat(c)),s.linesToInsert=null}}if(t=o,s.buffer=e.buffer||new ArrayBuffer(s.outIndex),s.dataView=new DataView(s.buffer),s.memPos=0,s.outIndex=0,s.currentPass=r.secondPass,t.forEach(function(n){if(s.line=n,s.lineExpressions=[],s.evaluatedLineExpressions=[],gn(s))return n;if("."===n[0])return L(s),void _n(s);var t=function(n,e){return n.symbolsByValue[e]||null}(s,s.memPos+s.outIndex);null!==t&&(s.currentLabel=t),n=s.line=L(s),e.text&&a.push(n);var r=Object(i.parse)(n);s.dataView.setUint32(s.outIndex,r),s.outIndex+=4}),s.ifElseStack.length)throw new Error("An if directive was used without an endif directive");if(0!==s.staticSymbolIndices[0])throw new Error("A beginfile directive was used without an endfile directive");return e.text?a:s.buffer}function gn(n){return!!n.ifElseStack.length&&!(n.ifElseStack[n.ifElseStack.length-1]&G.ExecutingBlock||function(n){var e=n.toLowerCase();return dn(e,".if")||dn(e,".else")||dn(e,".endif")}(n.line))}function bn(n){for(var e;e=a(n);)n.line=n.line.substr(e.length+1).trim();return n.line}function yn(n){var e=function(n){if("string"==typeof n)return n.split(/\r?\n/);if(!Array.isArray(n))throw new Error("Input must be a string or array of strings");return n}(n);return e=(e=(e=function(n){return n.map(function(n){var e=n.indexOf(";"),t=n.indexOf("//");if(-1===e&&-1===t)return n;var r=e;return-1===r?r=t:-1!==t&&(r=Math.min(e,t)),n.substr(0,r)})}(e=e.filter(function(n){return"string"==typeof n}))).map(function(n){return n.trim()})).filter(Boolean)}t.d(e,"assemble",function(){return mn})}])});